var Weglot = (function () {
  ...
  var t = {
      ddtags: "env:prod,version:5.90.2",
  ...
  function a(e) {
    ...
    function o(e, o, i) {
      ...
      if (
        ...
        c &&
          ...
          (function (e, r, a) {
            ...
            var i = Object.keys(n)
              ...
              .join("&");
            fetch("https://browser-intake-datadoghq.com/api/v2/logs?" + i, {
              method: "POST",
        ...
        var d = u || e,
          f = ["notice", "info"].includes(o) ? "log" : o;
        console[f]("[Weglot]", d);
      }
    }
    var i = function (e) {
  ...
  function i(e) {
    try {
      ...
      if ((a.init && ((a.api_key = a.init), delete a.init), !a.api_key)) return;
      return a;
    } catch (e) {
      o.warn(e);
    }
  ...
  var f = "wgVeExtension",
    g = "getCurrentLanguage",
    p = "setCurrentLanguage",
    h = "languageChanged",
    v = "library",
    _ = "extension",
    m = "proxy.weglot.com",
    ...
    A = ["regex", "json", "form_multipart", "form_urlencoded", "url_query"],
    T = ["WordPress", "CraftCMS"],
    C = "Shopify",
    O = "BigCommerce",
    j = "Squarespace",
    N = "Wix",
    ...
    I = "https://api.weglot.com/project-settings",
    D = "preview.weglot.io",
    M = "wg-style-trans",
    W = "data-wg-notranslate",
    z = "proxy.weglot.com",
    q = "wg-cgi",
    F = "wg-translations",
    U = "wg-slugs",
    ...
    V = {
      ...
      override_hreflang: "all",
    },
    $ = ["none", "shiny", "square", "circle", "rectangle_mat"],
    G = [];
  function K(e, t, n) {
    if (e) return n();
    J(t, n, !0);
  ...
  function J(e, t, n) {
    return (
      ...
      "function" != typeof t
        ? (o.error(
            "You should provide a callback function as second argument",
            { sendToDatadog: n }
          ),
          !1)
        : n || -1 !== H.indexOf(e)
        ? (G.push({ name: e, callback: t, internal: n }), !0)
        : (o.error("No Weglot event is named " + e, { sendToDatadog: !1 }), !1)
    );
  }
  function X(e) {
    ...
    for (
      ...
      try {
        ...
        o.error("Error triggering callback function: " + e, {
          sendToDatadog: !1,
        });
      }
    }
  ...
  !(function (e) {
    ...
    var t = Object.keys(Q).filter(function (e) {
      return !Q[e];
    });
    if (t.length) {
      !(function (e, t, n) {
  ...
  var oe = (function () {
      try {
        return JSON.parse(
          '{"TRANSLATION":"translations.weglot.io","EXCLUSION":"exclusions.weglot.io","DEFINITION":"definitions.weglot.io"}'
        );
      } catch (e) {
        return {};
      }
    })(),
    ie = Object.keys(oe).map(function (e) {
      return oe[e];
    });
  function se(e) {
    for (var t = 0, n = ie; t < n.length; t += 1) {
      var r = n[t];
  ...
  function pe() {
    if (!se(window.location.hostname) || !document.baseURI) {
    ...
    if (t && t.editorCurrentURL) {
      var n = new ue(t.editorCurrentURL),
        r = n.hostname,
        a = n.pathname,
        i = n.search;
      return { url: document.baseURI, hostname: r, pathname: a, search: i };
    }
    o.error("Problem finding editor page location", { sendToConsole: !1 });
    var s = new ue(document.baseURI),
      u = s.hostname,
      c = s.pathname,
      d = s.search;
    return { url: document.baseURI, hostname: u, pathname: c, search: d };
  }
  K(te && Object.keys(te).length > 0, "onOptionsReady", function () {
    if (te.dynamicPushState) {
      var e = history.pushState;
      history.pushState = function () {
        for (var t = [], n = arguments.length; n--; ) t[n] = arguments[n];
        te.wait_transition_dynamic && Pe() !== te.language_from && (de(), ge()),
          e.apply(history, t),
          X("onCurrentLocationChanged");
      };
    }
  });
  var he = function (e, t) {
    ...
    ve = he("querySelectorAll", []),
    _e = he("querySelector", null),
    me = he("closest", null);
  function ye(e) {
    e = "" + e;
  ...
  function Ee(e, t, n) {
    var r = new ue(e, location.href);
    return (
      r.searchParams.set(t, n),
      e.match(/^(https?:)?\/\//) ? r.href : "" + r.pathname + r.search
    );
  }
  var Le = function (e, t) {
    var n;
  ...
  function Oe(e) {
    return new Ce({ options: te, pathname: e || pe().pathname });
  }
  function je() {
    var e = pe().hostname,
      t = te.languages.find(function (t) {
        return (
          t.connect_host_destination && t.connect_host_destination.host === e
        );
      });
    return t ? t.custom_code || t.language_to : te.language_from;
  }
  function Ne() {
    return Oe().language;
  }
  function Re() {
    var e = l(),
      t = te.languages || [],
      n =
        (e && "current_language" in e && e.current_language) ||
        (document.documentElement &&
          document.documentElement.getAttribute("lang"));
    if (!n) return null;
    if (n === te.language_from) return te.language_from;
  ...
  function Pe() {
    ...
    if (te.is_connect) {
      ...
      return e ? ((Te = e), e) : (Te = te.subdirectory ? Ne() : je());
    }
    if (ae(te.technology)) {
      var t = Re();
      if (t) return (Te = t), t;
    }
    return (Te = te.language_from);
  }
  function Ie(e) {
    return {
  ...
  (Ce.prototype.setAdvancedLocaleRule = function () {
    var e,
      t = this,
      n = this.options,
    ...
    (Ce.prototype.advancedConvertLocale = function (e, t, n) {
      ...
      var r = this.localeRule,
        ...
        d = void 0 !== c ? c : a,
        f = null == s ? void 0 : s[e],
        g = void 0 === f ? i.replace(/CODE/g, e) : f,
        p = new RegExp(d);
      return t.replace(p, g);
    }),
    (Ce.prototype.getRegexPositions = function (e) {
      var t = 1;
      return e.replace(/\((.*?)\)/g, function () {
        return "$" + t++;
      });
    }),
    (Ce.prototype.setLocaleRule = function () {
      var e = this,
        t = this.options,
        n = t.localeRules;
      void 0 === n && (n = []);
      ...
      var l = n.find(function (t) {
        ...
        var i = t.pathTest;
        void 0 === i && (i = "");
        var s = t.originalFormat;
        void 0 === s && (s = "");
        var l = t.addedByDefault;
        if (!a.includes("CODE")) return !1;
        if (i)
          try {
            if (!new RegExp(i, "g").test(e.pathname)) return !1;
          } catch (e) {}
        var u = e.pathname.split("/");
        if (u.length <= n) return !1;
        var c = u[n + 1],
          d = r.find(function (t) {
            var n = Ae(t),
              r = a.replace("CODE", n),
              o = new RegExp("^" + r + "$", "g");
            return !!o.test(c) && ((e.translationRegex = o), !0);
          });
        if (d) return (e.detectedLanguage = Ae(d)), !0;
        if (s) {
          var f = s.replace("CODE", o);
          return new RegExp("^" + f + "$", "g").test(c);
        }
        return !l;
      });
      (this.localeRule = l || a), (this.language = this.detectedLanguage || o);
    }),
    (Ce.prototype.standardConvertLocale = function (e, t, n, r) {
    ...
    var i = (function (e, t) {
      ...
      var r = n.find(function (n) {
        ...
        if (!o || !o.length || o.includes(e)) {
          ...
          if (i !== t) return Ie(i)[r](a) ? n : void 0;
        }
      });
      return (
        !!r && {
          ...
          allExcluded:
            ...
            r.excluded_languages.length >= te.languages.length,
        }
      );
    })(a, r);
    return (De[r][a] = i), i;
  ...
  function ze() {
    if (We) return We;
    if (!te.api_key && !te.visual_editor)
      return (
        o.warn("Weglot must be initialized to use it.", { sendToDatadog: !1 }),
        []
      );
    var e = (te.languages || [])
        .filter(function (e) {
          var t = Me(e.language_to),
            n = !t || t.language_button_displayed;
          return (
            (!1 !== e.enabled || te.private_mode) &&
            n &&
            (te.subdirectory ||
              !te.is_connect ||
      ...
      t = [te.language_from].concat(e);
    return (
      (We = t.filter(function (e, n) {
        return e && t.indexOf(e) == n;
      })),
      e.length || o.log("No public language available.", { sendToDatadog: !1 }),
      We
    );
  }
  J(
  ...
  var qe,
    ...
    tt = {
      bubble: {
        hash: "4c590925c1043e7bd5299a3dba085f72909ec505",
        integrity:
          "sha384-daOXBdq0AFnsjgBfZLA9VhMk7rSmzV8jKvgs96Z7mITHgLzddonTne/r5ZhHqxCc",
        name: "bubble",
      },
      default: {
        hash: "63e0a1891f5522181649c08d955b777e4a36bcb6",
        integrity:
          "sha384-9hzRFRdK3Fj6ayA5Hd3lHomvoFk6WZEsdykuNZhp3rJu3ux9WdR6au7gklULYlXB",
        name: "default",
      },
      default_dropdown: {
        hash: "a593c858075919fac5aaa85799b06e73064099ae",
        integrity:
          "sha384-5wm0BRdUwuu5XeKl6cRbWHWhuyLi5hV2+QzY5txxAFXlfwYF4HogmGfLcMO1He8r",
        name: "default_dropdown",
      },
      horizontal_expand: {
        hash: "5fe12a02580c794d12c80cd06ef1852ac66cb753",
        integrity:
          "sha384-Ym9COZAhUVqRiVbJsy77WfcZu0wdj2vbbThOIeVhdu8ZCh8aFeICG+4hi2lFc47I",
        name: "horizontal_expand",
      },
      skewed: {
        hash: "f12bbbb07e4b7b0aeca5de41dd6901e7ff551b81",
        integrity:
          "sha384-RdlexX9RtFVCXGGLK0Hdjrj4sBoI4yglDvh9SW/ZbydZt0s4FEQwZeUPsDUuj5/I",
        name: "skewed",
      },
      toggle: {
        hash: "f8a5e0287ce1d4c030828e40836d49d72e86d883",
        integrity:
          "sha384-MRqwcsfeNItnEeafmwUGpKsGt3j6tsOpfltzRZrVSA9omf/Ur7qDbLdWw5SenogR",
        name: "toggle",
      },
      underline_edge: {
        hash: "5f9c51e2bb9a9e731478b4c7401f025d3f34be41",
        integrity:
          "sha384-GyuvLqmc2lvVPIaVWNnLpFlP5FZ8fo5ZVgAd7nTY9cAtLTbnQ1Ybsj+TQQYUYBOG",
        name: "underline_edge",
      },
      underline_full: {
        hash: "04593edfa2d64d5f0f1c687852675797d688e982",
        integrity:
          "sha384-YVqvpk98+HTzkb4NJ8ufxE/r1R1JBB5bXZTx89Q99vjacOtVA6c/WjYq83WmSXFN",
        name: "underline_full",
      },
      vertical_expand: {
        hash: "ddcf25427e5314d833a0f838c9508003ba80b1fe",
        integrity:
          "sha384-h0sFwW/+LZxjQKP5EJl+HngaN3CTvs7ngBjVQmE+CCrl9K3kM5t4P/G68jcQG6Nv",
  ...
  function lt(e, t, n) {
    ...
    if (
      (arguments.length > 2 &&
        (i.children = arguments.length > 3 ? qe.call(arguments, 2) : n),
      "function" == typeof e && null != e.defaultProps)
    )
      for (o in e.defaultProps) void 0 === i[o] && (i[o] = e.defaultProps[o]);
    return ut(e, i, r, a, null);
  }
  function ut(e, t, n, r, a) {
    ...
    return null == a && null != Fe.vnode && Fe.vnode(o), o;
  }
  function ct(e) {
    return e.children;
  }
  ...
  function ft(e, t) {
    if (null == t) return e.__ ? ft(e.__, e.__i + 1) : null;
    for (var n; t < e.__k.length; t++)
      if (null != (n = e.__k[t]) && null != n.__e) return n.__e;
    return "function" == typeof e.type ? ft(e) : null;
  }
  function gt(e) {
    if (e.__P && e.__d) {
      var t = e.__v,
  ...
  function ht(e) {
    ((!e.__d && (e.__d = !0) && He.push(e) && !vt.__r++) ||
      Be != Fe.debounceRendering) &&
      ((Be = Fe.debounceRendering) || Ve)(vt);
  }
  function vt() {
    try {
      for (var e, t = 1; He.length; )
        He.length > t && He.sort($e), (e = He.shift()), (t = He.length), gt(e);
    } finally {
      He.length = vt.__r = 0;
    }
  }
  function _t(e, t, n, r, a, o, i, s, l, u, c) {
    var d,
      f,
      g,
      p,
    ...
    for (
          ...
          null != (i = t[o]) && "boolean" != typeof i && "function" != typeof i
            ? ("string" == typeof i ||
              ...
              i.constructor == String
                ? (i = e.__k[o] = ut(null, i, null, null, null))
                : ot(i)
                ? (i = e.__k[o] = ut(ct, { children: i }, null, null, null))
                : void 0 === i.constructor && i.__b > 0
                ? (i = e.__k[o] =
                    ut(i.type, i.props, i.key, i.ref ? i.ref : null, i.__v))
                : (e.__k[o] = i),
              (l = o + f),
              (i.__ = e),
              (i.__b = e.__b + 1),
              (s = null),
              -1 != (u = i.__i = wt(i, n, l, d)) &&
                (d--, (s = n[u]) && (s.__u |= 2)),
              null == s || null == s.__v
                ? (-1 == u && (a > c ? f-- : a < c && f++),
      ...
      null != (g = n.__k[d]) &&
        ((f = (-1 != g.__i && _[g.__i]) || nt),
        (g.__i = d),
        (v = xt(e, g, f, a, o, i, s, l, u, c)),
        (p = g.__e),
        g.ref &&
          f.ref != g.ref &&
          (f.ref && Ct(f.ref, null, g), c.push(g.ref, g.__c || p, g)),
        null == h && null != p && (h = p),
        4 & g.__u
          ? ((l = mt(g, l, e)), f.__e && (f.__e = null))
  ...
  function wt(e, t, n, r) {
    var a,
      ...
      u = t[n],
      c = null != u && !(2 & u.__u);
    if ((null === u && null == s) || (c && s == u.key && l == u.type)) return n;
    if (r > (c ? 1 : 0))
  ...
  function bt(e, t, n) {
    "-" == t[0]
      ...
      : (e[t] =
          null == n ? "" : "number" != typeof n || at.test(t) ? n : n + "px");
  }
    ...
    e: if ("style" == t)
      ...
      (o = t != (t = t.replace(Xe, "$1"))),
        ...
        n
          ? r
            ? (n[Je] = r[Je])
            : ((n[Je] = Qe), e.addEventListener(t, o ? Ye : Ze, o))
          : e.removeEventListener(t, o ? Ye : Ze, o);
    else {
  ...
  function St(e) {
    return function (t) {
      if (this.l) {
        ...
        if (null == t[Ke]) t[Ke] = Qe++;
        else if (t[Ke] < n[Je]) return;
        return n(Fe.event ? Fe.event(t) : t);
      }
    };
  }
  function xt(e, t, n, r, a, o, i, s, l, u) {
    var c,
      d,
      f,
      g,
    ...
    e: if ("function" == typeof L) {
      ...
      try {
        if (
          ((m = t.props),
          (y = L.prototype && L.prototype.render),
          (w = (c = L.contextType) && r[c.__c]),
          (b = c ? (w ? w.props.value : c.__) : r),
          n.__c
          ...
          y &&
            ...
            (f.__s == f.state && (f.__s = it({}, f.__s)),
            it(f.__s, L.getDerivedStateFromProps(m, f.__s))),
          (p = f.props),
          (h = f.state),
          (f.__v = t),
          g)
          ...
          if (
            (y &&
              ...
              f.componentWillReceiveProps(m, b),
            t.__v == n.__v ||
              (!f.__e &&
                null != f.shouldComponentUpdate &&
                !1 === f.shouldComponentUpdate(m, f.__s, b)))
          ) {
            t.__v != n.__v && ((f.props = m), (f.state = f.__s), (f.__d = !1)),
              (t.__e = n.__e),
              (t.__k = n.__k),
              t.__k.some(function (e) {
                e && (e.__ = t);
              }),
              rt.push.apply(f.__h, f._sb),
              (f._sb = []),
        ...
        (f.state = f.__s),
          null != f.getChildContext && (r = it(it({}, r), f.getChildContext())),
          y &&
            !g &&
            null != f.getSnapshotBeforeUpdate &&
            (v = f.getSnapshotBeforeUpdate(p, h)),
          (x =
            null != c && c.type === ct && null == c.key
              ? At(c.props.children)
              : c),
          (s = _t(e, ot(x) ? x : [x], t, n, r, a, o, i, s, l, u)),
          (f.base = t.__e),
          (t.__u &= -161),
          f.__h.length && i.push(f),
          _ && (f.__E = f.__ = null);
      } catch (e) {
        if (((i.length = d), (t.__v = null), l || null != o)) {
          if (e.then) {
            for (
              t.__u |= l ? 160 : 128;
              ...
              s = s.nextSibling;
            null != o && (o[o.indexOf(s)] = null), (t.__e = s);
          } else if (null != o) for (E = o.length; E--; ) st(o[E]);
        } else t.__e = n.__e;
        null == t.__k && (t.__k = n.__k || []),
          e.then || Et(t),
          Fe.__e(e, t, n);
      }
    } else
      null == o && t.__v == n.__v
        ...
        : (s = t.__e = Tt(n.__e, t, n, r, a, o, i, l, u));
    return (c = Fe.diffed) && c(t), 128 & t.__u ? void 0 : s;
  }
  function Et(e) {
  ...
  function Tt(e, t, n, r, a, o, i, s, l) {
    ...
    if (null == e) {
      ...
      (e = document.createElementNS(a, m, _.is && _)),
        s && (Fe.__m && Fe.__m(t, o), (s = !1)),
        (o = null);
    }
    if (null == m) v === _ || (s && e.data == _) || (e.data = _);
    else {
      if (
        ((o =
          "textarea" == m && null != _.defaultValue
            ? null
            : o && qe.call(e.childNodes)),
        !s && null != o)
      )
      ...
      for (u in v)
        (g = v[u]),
          "dangerouslySetInnerHTML" == u
            ...
            : "children" == u ||
              u in _ ||
              ("value" == u && "defaultValue" in _) ||
              ("checked" == u && "defaultChecked" in _) ||
              kt(e, u, null, g, a);
      for (u in _)
        (g = _[u]),
          "children" == u
  ...
  function Ot(e, t, n) {
    ...
    if ((r = e.__k))
      for (a = 0; a < r.length; a++)
        r[a] && Ot(r[a], t, n || "function" != typeof e.type);
  ...
  (qe = rt.slice),
    ...
    (dt.prototype.setState = function (e, t) {
      ...
      (n =
        ...
        "function" == typeof e && (e = e(it({}, n), this.props)),
        e && it(n, e),
        null != e && this.__v && (t && this._sb.push(t), ht(this));
    }),
    (dt.prototype.forceUpdate = function (e) {
      this.__v && ((this.__e = !0), e && this.__h.push(e), ht(this));
    }),
    (dt.prototype.render = ct),
    (He = []),
    (Ve =
    ...
    (vt.__r = 0),
    (Ge = Math.random().toString(8)),
    (Ke = "__d" + Ge),
    (Je = "__a" + Ge),
    (Xe = /(PointerCapture)$|Capture$/i),
    (Qe = 0),
    (Ze = St(!1)),
    (Ye = St(!0)),
    (et = 0);
  ...
  var It = {
      ...
      removeItem: function (e) {
        return Pt.erase({ name: e, options: te });
      },
    },
    Dt = {
      getItem: function () {},
  ...
  function Mt(e) {
    var t = e || "local";
    try {
      return "cookie" === t ? It : window[t + "Storage"];
    } catch (e) {}
    return e ? Dt : Mt("local" === t ? "cookie" : "local");
  }
  var Wt = { slugs: {}, pendingRequest: void 0, requestResolved: !1 };
  function zt(e, t) {
    void 0 === t && (t = 0);
    var n = te.api_key,
      r = te.versions;
    if (!r || !r.slugTranslation) return Promise.resolve({});
    var a = te.api_domain || "cdn-api-weglot.com",
      o =
        ...
        return zt(n)
          .then(function (e) {
            !(function (e, t) {
              var n,
                r = {
                  slugs: Object.assign({}, Wt.slugs, ((n = {}), (n[e] = t), n)),
                };
              Ft(r), Object.assign(Wt, r);
            })(t || n, { version: te.versions.slugTranslation, slugs: e });
          })
          .catch(function () {});
      })
    );
  ...
  function Ft(e) {
    try {
      var t = Mt("local");
      t && t.setItem(U, JSON.stringify(e));
    } catch (e) {
      o.warn(e);
    }
  }
  function Ut() {
    if (!Wt.slugs) return {};
    var e = Pe() === te.language_from;
    return Object.keys(Wt.slugs).reduce(function (t, n) {
      var r = Wt.slugs[n],
        a = r.slugs,
        o = r.version < te.versions.slugTranslation && e ? {} : a;
      return (
        (t[n] = (function (e) {
  ...
  function Ht(e) {
    ...
    if (t && t.slugTranslation) {
      var n = te.languages.filter(function (e) {
        var n = e.custom_code,
          r = e.language_to,
          a = n || r;
        return !Wt.slugs[a] || Wt.slugs[a].version < t.slugTranslation;
      });
      n.length
        ? Wt.requestResolved
          ? e(Ut())
          : !Wt.pendingRequest || Wt.requestResolved
          ? (Wt.pendingRequest = qt(n)
              .then(function () {
                (Wt.requestResolved = !0), e(Ut());
              })
              .catch(function () {
                (Wt.requestResolved = !0), e(Ut());
              }))
          : Wt.pendingRequest.then(function () {
              return e(Ut());
            })
        : e(Ut());
    } else e({});
  ...
  !(function () {
    if (Object.keys(Wt.slugs).length) return;
    try {
      var e = Mt("local");
      if (!e) return;
      var t = e.getItem(U);
      ...
      if (void 0 !== n.version) {
        ...
        return (Wt.slugs = r), void Ft({ slugs: r });
      }
      return void Object.assign(Wt, n);
    } catch (e) {
      return;
    }
  })();
  ...
  function $t(e, t) {
    (te.auto_switch || te.geo_auto_switch) &&
      (te.is_tld || te.rendered) &&
      (e === te.language_from
  ...
  function Gt(e, t, n) {
    ...
    if (n) {
      ...
      try {
        n = new ue(n, window.location.origin);
      } catch (e) {
        return n;
      }
    } else
      (n = new ue(pe().url)),
        te.visual_editor &&
          ...
          (n = new ue(n.searchParams.get("url"))),
        n.searchParams.has("lang") && n.searchParams.delete("lang"),
        $t(e, n);
    var a = (function (e) {
      var t;
      if (!te.subdirectory) {
        var n = te.language_from,
          r = te.host,
          a = te.languages;
        if (e === n) return r;
        ...
        return null === (t = null == o ? void 0 : o.connect_host_destination) ||
          void 0 === t
          ? void 0
          : t.host;
      }
    ...
    return (
      ...
      (n.pathname = (function (e, t, n) {
        ...
        if (!Bt[t]) {
          var r = Pe();
          if (r !== te.language_from && e[r]) {
            var a = e[r].translated;
            Bt[t] = Vt(t, a);
          } else Bt[t] = t;
        }
        return n === te.language_from
          ? Bt[t]
          : e[n] && e[n].original
          ? Vt(Bt[t], e[n].original)
          : t;
      })(t, n.pathname, e)),
      te.subdirectory &&
        e &&
        (n.pathname = Oe(n.pathname).convertLocale(e, n.pathname)),
      r ? "" + n.pathname + n.search + n.hash : n.toString()
    );
  }
  function Kt(e, t) {
    if (ae(te.technology) && !te.is_connect) {
      if (te.injectedData && te.injectedData.switcher_links) {
        var n = re(e, te),
          r = te.injectedData.switcher_links[n];
        return t(r);
      }
      var a = (function (e) {
      ...
      return a
        ? t(a)
        : (o.error("No switcher_links or hreflang elements found.", {
            sendToDatadog: !1,
          }),
          t("#"));
    }
    if (!te.is_connect || !e) return t("#");
    var i = te.dynamicPushState,
      s = te.injectedData;
    void 0 === s && (s = {});
    var l = s.allLanguageUrls;
    if ((void 0 === l && (l = {}), !i && l && l[e])) {
      var u = new ue(l[e]);
      return $t(e, u), t(u.toString());
    }
    Ht(function (n) {
      return t(Gt(e, n));
    });
  ...
  var Jt,
    Xt = {
      ...
      "es-419": { name: "Español Latinoamericano", flag: "mx", rtl: !1 },
  ...
  function Qt(e) {
    ...
    t && (e = t.new);
    var n = e.toLowerCase(),
      r = te.languages.find(function (e) {
        var t = e.language_to,
          r = e.custom_code;
        return t === n || (r ? r.toLowerCase() === n : void 0);
      });
    return (null == r ? void 0 : r.custom_local_name)
      ? r.custom_local_name
      : (null == r ? void 0 : r.custom_name)
      ? r.custom_name
      : n === te.language_from && te.language_from_custom_name
      ? te.language_from_custom_name
      : Xt[n]
      ? Xt[n].name
      : "Unknown";
  }
  var Zt = {
    ...
    Yt =
      null === (Jt = oe.TRANSLATION) || void 0 === Jt
        ? void 0
        : Jt.split(".").slice(0, -1).join(".");
  window.location.hostname.includes(Yt);
  var en = {
    ...
    el: ["Γλώσσα", "Επιλεγμένη γλώσσα", "Λίστα γλωσσών", "Μεταγωγέας γλώσσας"],
    en: ["Language", "Language selected", "Language list", "Language Switcher"],
    ...
    ha: ["Harshe", "Harshen da aka zaɓa", "Jerin harsuna", "Mai canza harshe"],
    ...
    id: ["Bahasa", "Bahasa yang dipilih", "Daftar bahasa", "Pengganti bahasa"],
    ig: ["Asụsụ", "Asụsụ ahọpụtara", "Ndepụta asụsụ", "Onye na-agbanwe asụsụ"],
    ...
    lb: ["Sprooch", "Ausgewielte Sprooch", "Sproochleischt", "Sproochwiessel"],
    ...
    sl: ["Jezik", "Izbrani jezik", "Seznam jezikov", "Preklapljalnik jezikov"],
    ...
    sq: ["Gjuha", "Gjuha e zgjedhur", "Lista e gjuhëve", "Ndryshuesi i gjuhës"],
    sr: ["Језик", "Изабрани језик", "Списак језика", "Прекидач језика"],
    "sr-latn": ["Jezik", "Izabrani jezik", "Spisak jezika", "Prekidač jezika"],
  ...
  function nn(e) {
    return (function (e, t, n) {
      ...
      if (t.language_from === e) return t.language_from_custom_flag || tn(e, n);
      var r = e.toLowerCase(),
      ...
      return a ? a.custom_flag || tn(a.language_to, n) : "";
    })(e, te, Xt);
  }
  var rn,
    an,
    ...
    vn = cn.__;
  function _n(e, t) {
    cn.__h && cn.__h(an, e, ln || t), (ln = 0);
    var n = an.__H || (an.__H = { __: [], __h: [] });
        ...
        if (
          ...
          var a = function (e, t, n) {
            ...
            if (
              ...
              var s = o.call(this, e, t, n);
              return a ? s || i : s;
            }
            return !a || i;
          };
          an.__f = !0;
          var o = an.shouldComponentUpdate,
            i = an.componentWillUpdate;
          (an.componentWillUpdate = function (e, t, n) {
            if (this.__e) {
              var r = o;
  ...
  function yn(e, t) {
    var n = _n(rn++, 3);
    !cn.__s && Ln(n.__H, t) && ((n.__ = e), (n.u = t), an.__H.__h.push(n));
  }
  function wn(e) {
    return (
      (ln = 5),
  ...
  function bn() {
    for (var e; (e = un.shift()); ) {
      ...
      if (e.__P && t)
        try {
          t.__h.some(xn), t.__h.some(En), (t.__h = []);
        } catch (n) {
          (t.__h = []), cn.__e(n, e.__v);
        }
    }
  }
  (cn.__b = function (e) {
    ...
    (cn.__ = function (e, t) {
      e && t.__k && t.__k.__m && (e.__m = t.__k.__m), vn && vn(e, t);
    }),
    (cn.__r = function (e) {
      fn && fn(e), (rn = 0);
      var t = (an = e.__c).__H;
      t &&
        (on === an
          ...
          : (t.__h.some(xn), t.__h.some(En), (t.__h = []), (rn = 0))),
        (on = an);
    }),
    (cn.diffed = function (e) {
      ...
      t &&
        t.__H &&
        (t.__H.__h.length &&
          ((1 !== un.push(t) && sn === cn.requestAnimationFrame) ||
            ((sn = cn.requestAnimationFrame) || Sn)(bn)),
  ...
  function xn(e) {
    var t = an,
      n = e.__c;
    "function" == typeof n && ((e.__c = void 0), n()), (an = t);
  }
  function En(e) {
    var t = an;
    (e.__c = e.__()), (an = t);
  ...
  ((On.prototype = new dt()).isPureReactComponent = !0),
    (On.prototype.shouldComponentUpdate = function (e, t) {
  ...
  (Fe.unmount = function (e) {
    ...
    ((Mn.prototype = new dt()).__c = function (e, t) {
      var n = t.__c,
        r = this;
      ...
      var a = Wn(r.__v),
        o = !1,
        i = function () {
          o || r.__z || ((o = !0), (n.__R = null), a ? a(l) : l());
        };
      n.__R = i;
      var s = n.__P;
      n.__P = null;
      var l = function () {
        if (!--r.__u) {
          if (r.state.__a) {
            var e = r.state.__a;
            r.__v.__k[0] = Dn(e, e.__c.__P, e.__c.__O);
          }
          var t;
    ...
    (Mn.prototype.render = function (e, t) {
      if (this.__b) {
        if (this.__v.__k) {
          ...
          this.__v.__k[0] = In(this.__b, n, (r.__O = r.__P));
        }
        this.__b = null;
      }
      var a = t.__a && lt(ct, null, e.fallback);
      return a && (a.__u &= -33), [lt(ct, null, t.__a ? null : e.children), a];
    });
  ...
  ((zn.prototype = new dt()).__a = function (e) {
    var t = this,
      n = Wn(t.__v),
      r = t.l.get(e);
    return (
      ...
      function (a) {
        var o = function () {
          t.props.revealOrder ? (r.push(a), qn(t, e, r)) : a();
        };
        n ? n(o) : o();
      }
    );
    ...
    (zn.prototype.componentDidUpdate = zn.prototype.componentDidMount =
      function () {
        var e = this;
  ...
  var Fn =
    ...
    Hn = /^on(Ani|Tra|Tou|BeforeInp|Compo)/,
    Bn = /[A-Z0-9]/g,
  ...
  (dt.prototype.isReactComponent = !0),
    [
      "componentWillMount",
      ...
      (function (e) {
        ...
        "select" == n &&
          (r.multiple &&
            ...
            (r.value = yt(t.children).forEach(function (e) {
          ...
          t.class && !t.className
            ? ((r.class = t.class), Object.defineProperty(r, "className", Kn))
        ...
        var o = (function (e, t) {
          function n(e) {
            ...
            return (
              ...
              t ? !t(this.props, e) || n != e.ref : Cn(this.props, e)
            );
          }
          function r(t) {
            return (this.shouldComponentUpdate = n), lt(e, t);
          }
          return (
          ...
          (function (e) {
            ...
            var u = (function (e, t) {
              ...
              c = u,
              d = (function (e) {
                var t = an.context[e.__c],
                  n = _n(rn++, 9);
                return (
                  (n.c = e),
                  t
                    ? (null == n.__ && ((n.__ = !0), t.sub(an)), t.props.value)
                    : e.__
                );
              })(Zn);
            return lt(
  ...
  function tr(e) {
    ...
    var r = e.children,
      a = (function (e) {
        ...
        return (
          (t.__ = e),
          an.componentDidCatch ||
            (an.componentDidCatch = function (e, r) {
              t.__ && t.__(e, r), n[1](e);
            }),
          [
            n[0],
  ...
  var ir = ["text_active", "text_inactive", "text_hover"],
    sr = ["bg_active", "bg_inactive", "bg_hover"],
    lr = [
      {
        name: "default",
        editorDropdown: !0,
      ...
      {
        name: "toggle",
        editableProps: ["hide_selected_language"].concat(ir, sr),
        defaultValues: {
          style: { full_name: !1 },
      ...
      },
      {
        name: "horizontal_expand",
        editorDropdown: !1,
        editableProps: ["open_hover", "close_outside_click"].concat(ir, sr),
        defaultValues: {
          style: {
            with_name: !0,
            with_flags: !1,
      ...
      {
        name: "underline_edge",
        editableProps: ["full_name", "hide_selected_language"].concat(ir),
        maxLanguages: 10,
        minLanguages: null,
        defaultValues: {
          style: { full_name: !1 },
  ...
  var cr = a({ service: "switcher-templates" });
  function dr() {
    var e, t, n, r;
    if (ae(te.technology) && !te.is_connect) {
      if (
        null === (e = te.injectedData) || void 0 === e
          ? void 0
          : e.current_language
      ) {
        var a = te.injectedData.current_language,
          o = te.languages.find(function (e) {
            return e.language_to === a;
          });
        return (o && o.custom_code) || a || te.language_from;
      }
      if (te.visual_editor) {
        var i =
          (null ===
            (n =
              null === (t = window.Weglot) || void 0 === t
                ? void 0
                : t.options) || void 0 === n
            ? void 0
            : n.current_language) ||
          (function () {
            ...
            var n = t.toLowerCase(),
              r = [n, n.slice(0, 2)],
              a = function (e) {
                return !!e && r.includes(e.toLowerCase());
              };
            if (a(te.language_from)) return te.language_from;
            var o =
              null === (e = te.languages) || void 0 === e
                ? void 0
                : e.find(function (e) {
                    return a(e.language_to) || a(e.custom_code);
                  });
            return o ? o.custom_code || o.language_to : void 0;
          })();
        if (i) return i;
      }
    }
    return te.visual_editor &&
      !(null === (r = window.Weglot) || void 0 === r ? void 0 : r.initialized)
      ? te.language_from
  ...
  var pr = 13,
    ...
    _r = 40,
    mr = 32;
  var yr = ["none", "shiny", "square", "circle", "rectangle_mat"];
  function wr(e) {
    return e
  ...
  function br() {
    var e = dr(),
      t = Qt(e),
      n = en[e] || en[Zt[e]] || en.en;
    return {
      language: n[0],
      languageSelected: n[1],
      languageList: n[2],
      languageSwitcher: n[3] + ": " + t,
    };
  }
  function kr(e, t) {
        ...
        if (e && 1 !== e) {
          var r,
            ...
            c =
              ...
              !te.custom_css || te.switcher_gallery
                ? u
                : u + "\n\n" + te.custom_css);
          !(function (e, t) {
            if (e) {
  ...
  function xr(e) {
    ...
    function b() {
      ...
      var n = e.left;
      void 0 === n && (n = 0),
        w(t > window.innerHeight / 2),
        _(n > window.innerWidth / 2),
        l(!0);
    }
    function k() {
      l(!1), p(null);
    ...
    function x(e) {
      o(e),
        (function (e) {
          var t;
          if (!te.switcher_gallery) {
            if (
              (!te.visual_editor || !ae(te.technology)) &&
              (null === (t = window.Weglot) || void 0 === t
                ? void 0
                : t.switchTo)
            )
              return window.Weglot.switchTo(e);
            Kt(e, function (e) {
              e &&
                "#" !== e &&
                (te.visual_editor
    ...
    return (
      yn(
        function () {
          g && c.current.scrollIntoView({ block: "center" });
        },
        [g]
      ),
      {
        ...
        handleKeyDown: function (e) {
          return e.keyCode === mr || e.keyCode === pr
            ? (e.preventDefault(), g && x(g), S())
            : e.keyCode === _r || e.keyCode === vr
            ? (e.preventDefault(),
              void (function (e) {
                var t = e === _r ? "down" : "up",
                  n = d.slice(-1).pop(),
            ...
            : void (e.keyCode === hr && s && (e.preventDefault(), S()));
        },
        switchLanguage: x,
        toggleOpen: S,
      }
  ...
  var Er = Yn("div")(function () {
    ...
    Ar = function (e) {
      ...
      if (
        !(
          1 === te.category &&
          "Squarespace" !== te.technology &&
          "Shopify" !== te.technology &&
          !ae(te.technology) &&
          !n &&
          !te.hide_switcher_watermark
        )
      )
        return null;
      var r =
        te.switcher_editor || te.visual_editor
          ? void 0
    ...
    Or = function (e) {
      ...
      var f = t.with_flags,
        ...
        h = br(),
        v = !!s && n === s,
        _ = d ? Qt(n) : n.toUpperCase(),
        m = l ? "div" : "li",
        y = yr.indexOf(p || "rectangle_mat"),
      ...
      return lt(
        ...
        lt(
          ...
          f && !a && lt(Cr, { language: n, flagType: p, size_scale: g }),
          c && _
        )
      );
    };
  function jr(e) {
    ...
    return [
      ...
      },
      {
        ...
        declarations: {
          paddingRight: fr(22, n(40), 40) + "px",
          paddingLeft: fr(5, n(10), 10) + "px",
        },
      },
    ];
  }
  var Nr = "default",
    Rr = (function (e, t) {
      return function (n) {
        ...
        !(function (e, t) {
          ...
          t == document && (t = document.documentElement),
            ...
            xt(
              t,
              (e = t.__k = lt(ct, null, [e])),
              n || nt,
              nt,
              t.namespaceURI,
              n ? null : t.firstChild ? qe.call(t.childNodes) : null,
              r,
          ...
          lt(
            tr,
            { logger: cr.error, displayError: !1 },
            lt(e, {
      ...
      var k = t.is_dropdown,
        ...
        A = ze().filter(function (e) {
          return (!E && !L) || e !== s;
        }),
        T =
          /background-position/i.test(te.custom_css) &&
          !te.languages.some(function (e) {
      ...
      return _
        ? lt(
            "aside",
            {
              ...
              onMouseEnter: d,
              onMouseLeave: f,
              className: "weglot_switcher country-selector " + Nr + " " + C,
              "aria-label": x.languageSelected + ": " + Qt(s),
            },
            E &&
              !L &&
              lt(Or, {
    ...
    Pr = function () {
      (this.alreadyAddedSwitcher = !1),
        (this.defaultSwitcher = null),
        (this.defaultSwitcherTimeout = null),
        (this.langSwitchers = []),
        (this.detectedLinks = []);
    };
  (Pr.prototype.getAlreadyAddedSwitcher = function () {
    return this.alreadyAddedSwitcher;
  }),
    (Pr.prototype.setAlreadyAddedSwitcher = function (e) {
      this.alreadyAddedSwitcher = e;
    }),
    (Pr.prototype.getDefaultSwitcher = function () {
      return this.defaultSwitcher;
    }),
    (Pr.prototype.setDefaultSwitcher = function (e) {
      this.defaultSwitcher = e;
    }),
    (Pr.prototype.getDefaultSwitcherTimeout = function () {
      return this.defaultSwitcherTimeout;
    }),
    (Pr.prototype.setDefaultSwitcherTimeout = function (e) {
      this.defaultSwitcherTimeout = e;
    }),
    (Pr.prototype.getLangSwitchers = function () {
      return this.langSwitchers;
    }),
    (Pr.prototype.addLangSwitcher = function (e) {
      this.langSwitchers.push(e);
    }),
    (Pr.prototype.clearLangSwitchers = function () {
      this.langSwitchers.splice(0);
    }),
    (Pr.prototype.getDetectedLinks = function () {
      return this.detectedLinks;
    }),
    (Pr.prototype.addDetectedLink = function (e) {
      this.detectedLinks.push(e);
    }),
    (Pr.prototype.findDetectedLink = function (e) {
      return this.detectedLinks.find(function (t) {
        return t.language === e;
      });
    }),
    (Pr.prototype.removeDetectedLink = function (e, t) {
      var n = this.findDetectedLink(e);
      if (n) {
        var r = n.links.indexOf(t);
        -1 !== r && n.links.splice(r, 1);
      }
    }),
    (Pr.prototype.clearDetectedLinks = function () {
      this.detectedLinks.splice(0);
    }),
    (Pr.prototype.reset = function () {
      (this.alreadyAddedSwitcher = !1),
        (this.defaultSwitcher = null),
        this.defaultSwitcherTimeout &&
          clearTimeout(this.defaultSwitcherTimeout),
        (this.defaultSwitcherTimeout = null),
        this.langSwitchers.splice(0),
        this.detectedLinks.splice(0);
    });
  ...
  function Dr() {
    var e;
    location.search.includes("weglot-private=0") &&
      Mt().removeItem("wg-private-mode");
    var t =
      document.getElementById("admin-bar-iframe") ||
      document.getElementById("preview-bar-iframe") ||
      location.search.includes("weglot-private=1") ||
      se(window.location.hostname) ||
      (null === (e = window.location.hostname) || void 0 === e
        ? void 0
        : e.includes("preview.weglot.io")) ||
      "1" === Mt("cookie").getItem("wg-private-mode");
    return t && Mt("cookie").setItem("wg-private-mode", "1"), !!t;
  }
  function Mr(e, t) {
    return new Promise(function (n) {
      (function (e, t) {
        ...
        return new Promise(function (e, l) {
          var u =
              !(null == t ? void 0 : t.switcher_editor) && r ? n + "." + r : n,
            c =
              document.getElementsByTagName("head")[0] ||
              document.documentElement,
            d = document.createElement("script");
          (d.type = "text/javascript"),
            (d.src = "https://cdn.weglot.com/switchers/" + u + ".min.js"),
        ...
        .then(function (r) {
          ...
          if (!r) {
            var i =
              null ===
                (o =
                  null === (a = window.Weglot) || void 0 === a
                    ? void 0
                    : a.switchers) || void 0 === o
                ? void 0
                : o[e.name];
            (null == i ? void 0 : i.addSwitchers) && i.addSwitchers(t);
          }
          n();
        })
        .catch(function () {
  ...
  function Wr() {
    if (te.hide_switcher) return !1;
    if (Ir.getAlreadyAddedSwitcher()) return !0;
  ...
  function zr(e, t) {
    ...
    if ((void 0 === t && (t = document.documentElement), e && !e.ready)) {
      ...
      var i = (function (e, t) {
        ...
        var o,
          i = Array.from(ve(t, r));
        if (!r || !i.length) return { targetNode: a[0], siblingNode: null };
      ...
      if (!("error" in i)) {
        var s = Rr(Object.assign({}, e, { style: r }));
        if (
          ((s.weglotSwitcher = e),
          Ir.addLangSwitcher(s),
          "defaultPosition" in i)
        ) {
          s.classList.add("wg-default");
          var l =
            document.body ||
            document.documentElement ||
            (null === (n = null == t ? void 0 : t.getRootNode) || void 0 === n
              ? void 0
              : n.call(t));
          if (!l || !l.appendChild) return;
          return l.appendChild(s), (e.ready = !0), s;
        }
        var u = i.targetNode,
          d = i.siblingNode;
        return (
          s.setAttribute("data-switcher-style-opt", JSON.stringify(r)),
          u.insertBefore(s, d),
          (e.ready = !0),
          (function (e) {
            for (
              var t = 0, n = e.querySelectorAll(".weglot-container:empty");
              t < n.length;
              t += 1
            )
              c(n[t]);
      ...
      Dr() && o.warn(i.error, { sendToDatadog: !1 });
    }
  }
  function qr(e) {
    var t,
      ...
      r =
        null ===
          (n =
            null === (t = te.linkHooksConfig) || void 0 === t
              ? void 0
              : t.buildAdditionalSelectors) || void 0 === n
          ? void 0
          : n.call(t, e);
    return [
      "a[href='#Weglot-" + e + "']",
  ...
  function Hr(e) {
    ...
    for (
      ...
      var c = u[l],
        ...
        f = d.substring(0, 2);
      if (n[d]) return n[d];
      for (var g = 0, p = Ur; g < p.length; g += 1) {
        var h = p[g],
          v = h.codes,
          _ = h.pattern,
          m = v.find(function (t) {
  ...
  function Vr() {
    if (window.location.search.indexOf("no_redirect=true") > -1) $r(Pe());
    else if (
      !(
        !te.auto_switch ||
        (te.subdirectory && te.injectedData) ||
        Mt("cookie").getItem("WG_CHOOSE_ORIGINAL") ||
        Se() ||
        te.visual_editor
      )
    ) {
      var e = Br(document.referrer);
      if ((null == e ? void 0 : e.hostname) !== window.location.hostname) {
        var t = Hr();
        return t && !Me(t)
          ? t
          : te.auto_switch_fallback && !Me(te.auto_switch_fallback)
          ? te.auto_switch_fallback
          : void 0;
      }
    }
  }
  function $r(e) {
    if (e === te.language_from) {
      var t = new Date();
      t.setTime(t.getTime() + 2592e6),
        Mt("cookie").setItem("WG_CHOOSE_ORIGINAL", "1", {
          expires: t.toUTCString(),
        });
    } else Mt("cookie").removeItem("WG_CHOOSE_ORIGINAL");
  }
  function Gr() {
    var e = Mt().getItem(B);
    if (e && ze().includes(e)) return e;
  }
  var Kr = function (e) {
    return e && Mt().setItem(B, e);
  };
  function Jr() {
    var e = s("wg_progress");
    e && c(e);
  }
  var Xr = "undefined" != typeof WeakMap ? new WeakMap() : null;
  function Qr(e) {
    Xr ? Xr.set(e, !0) : (e.wgTracked = !0);
  }
  function Zr(e) {
    return Xr ? Xr.has(e) : !!e.wgTracked;
  }
  var Yr = [];
  function ea() {
    return Yr;
  ...
  var ra = new Set(),
    ...
    ia = !1;
  function sa(e, t) {
    void 0 === e && (e = ea()), void 0 === t && (t = {});
    var n = te.prevent_retranslation,
      r = te.injectedData;
    void 0 === r && (r = {});
    var a = te.is_connect;
    if (n && a && !ia) {
  ...
  var la,
    ...
    ca = {
      ...
      v3: ["A", "BDI", "BR", "WBR", "DEL", "DFN", "INS", "S", "SPAN", "MARK"],
    };
  var da = (function () {
      if (la) return ua;
      la = 1;
      var e = ca;
      return e.v2.unshift("#text"), (ua.mergeNodesList = e), ua;
    })(),
    fa = {
      excluded_blocks: [],
      excluded_attributes: [],
    ...
    ga = a({ service: "html-parser-engine" });
  function pa(e, t, n) {
    var r = t && t[e];
  ...
  function ha(e) {
    return pa("__validMergeNodes", e, function (e) {
      return (
        e &&
        ma(e) &&
        va(e) &&
        !(function (e) {
          return pa("__containsNoTranslateNodes", e, function (e) {
            return (
              1 === e.nodeType &&
              (!!e.querySelector("[" + fa.noTranslateAttribute + "]") || ya(e))
            );
          });
        })(e)
      );
  ...
  function va(e, t) {
    return (
      void 0 === t && (t = !0),
      pa("__validTextNodes", e, function (e) {
        return !(
          !e.textContent ||
  ...
  function _a(e) {
    try {
      if (
        fa.mergedSelectorRemove &&
        Ea(e.closest ? e : e.parentNode, fa.mergedSelectorRemove)
      )
        return !1;
    } catch (e) {}
    return (
      !(!fa.mergeNodes || -1 === fa.mergeNodes.indexOf(e.nodeName)) ||
      (e.dataset && void 0 !== e.dataset.wgMerge) ||
      (fa.selectorMerging && e.matches && e.matches(fa.selectorMerging))
    );
  }
  function ma(e) {
    return pa("__onlyInlineChildsNodes", e, function (e) {
      if (!e.childNodes) return !0;
      for (var t = 0, n = e.childNodes; t < n.length; t += 1) {
        var r = n[t];
        if (r.weglot || !_a(r) || !ma(r)) return !1;
      }
      return !0;
    });
  }
  function ya(e) {
    ...
    for (var t = 0, n = e.children; t < n.length; t += 1) {
      var r = n[t];
      if (("wgNoTranslate" in r && r.wgNoTranslate) || ya(r)) return !0;
    }
    return !1;
  }
  function wa(e) {
    return (
      !!e &&
      (!(!("wgNoTranslate" in e) || !e.wgNoTranslate) || wa(e.parentNode))
    );
  }
  function ba(e) {
    if (!e) return !1;
    var t = e.closest ? e : e.parentNode;
    return !(!t || !Ea(t, "[" + fa.noTranslateAttribute + "]")) || wa(e);
  }
  var ka = function (e, t) {
      return function (n, r) {
        try {
  ...
  function Oa(e) {
    ...
    if (
      ((function (e) {
        var t = fa.excludedBlocksSelector;
        if (!t) return void (e.wgNoTranslate = !1);
        xa(e, t) ? Da(e) : (e.wgNoTranslate = !1);
        for (var n = 0, r = Sa(e, t); n < r.length; n += 1) {
          Da(r[n]);
        }
        Ma(e, t);
      })(t),
      !fa.whitelist || !fa.whitelist.length)
    )
      return [].concat(
        (function (e) {
          var t = document.getElementsByTagName("title")[0];
          if (e !== document.documentElement || !document.title || !t || ba(t))
            return [];
          return [
            {
    ...
    var n = fa.whitelist
      ...
      .join(",");
    if (Ea(t, n)) return ja(t);
    for (var r = [], a = 0, o = Sa(t, n); a < o.length; a += 1) {
      var i = o[a];
      [].push.apply(r, ja(i));
    }
    return r;
  ...
  function ja(e) {
    return [].concat(
      ...
      (function (e) {
        var t,
          n = [],
          r = fa.translation_engine >= 2,
          a = document.createTreeWalker(e, 4, Na, !1);
        for (; (t = a.nextNode()); ) {
          var o = (
            r && (_a(t.parentNode) || t.parentNode.childNodes.length > 1)
              ? Ra
              : Pa
          )(t, a);
          o && n.push(o);
  ...
  function Ra(e, t) {
    ...
    if (a) {
      var o = a[0],
        ...
        s = a[2];
      if (!za(i))
        return Ca.set(o, a), { element: o, words: i, type: 1, properties: s };
    }
  }
  function Pa(e) {
    var t = e.textContent;
    if (!za(t)) return { element: e, words: t, type: 1, properties: {} };
  }
  function Ia(e, t) {
    var n = fa.excluded_attributes;
    if (!n || !n.length) return !1;
    for (var r = 0, a = n; r < a.length; r += 1) {
      ...
      if (o) {
        var i = o.selector,
          s = o.attributes;
        if (i && s && Array.isArray(s) && s.includes(t) && xa(e, i)) return !0;
      }
    }
    return !1;
  }
  function Da(e) {
    if (fa.private_mode) {
      var t = fa.excluded_blocks.find(function (t) {
        return xa(e, t.value);
      });
      e.wgNoTranslate = !t || "Excluded by selector: " + t.value;
  ...
  Na.acceptNode = Na;
  var qa =
      /<script|<iframe|<object|<embed|<form|<base|<noscript|<link[^>]+(?:import|preload[^>]+script)|<meta[^>]+http-equiv|\bon\w+\s*=/i,
    Fa = [
      "javascript:",
      "vbscript:",
      "data:text/html",
    ...
    Ua = new Set(["href", "src", "action", "formaction", "data", "poster"]),
  ...
  function $a(e) {
    var t = e.tagName;
    if (Ba.has(t)) return !("META" === t && !e.hasAttribute("http-equiv"));
    if ("LINK" === t) {
      var n = e.getAttribute("rel");
      if (n) {
        var r = n.toLowerCase();
        if ("import" === r) return !0;
        if ("preload" === r) {
          var a = e.getAttribute("as");
          if (a && "script" === a.toLowerCase()) return !0;
        }
      }
    }
    return !1;
  ...
  function Ka(e) {
    for (
      var t = e.replace(Ga, "").trim().toLowerCase(), n = 0, r = Fa;
      n < r.length;
      n += 1
    ) {
      var a = r[n];
  ...
  function Ja(e) {
    for (var t = 0, n = e.getAttributeNames(); t < n.length; t += 1) {
      var r = n[t];
      r.toLowerCase().startsWith("on") && e.removeAttribute(r);
    }
  }
  function Xa(e) {
    try {
      if (
        ((Va.innerHTML = e),
        (function (e) {
          for (var t = 0, n = Ua; t < n.length; t += 1)
            for (
              var r = n[t], a = "[" + r + "]", o = 0, i = e.querySelectorAll(a);
              o < i.length;
              o += 1
            ) {
              var s = i[o],
                l = s.getAttribute(r);
              l && Ka(l) && s.removeAttribute(r);
            }
          for (var u = 0, c = e.querySelectorAll("*"); u < c.length; u += 1) {
            var d = c[u],
              f = d.getAttributeNS(Ha, "href");
            f && Ka(f) && d.removeAttributeNS(Ha, "href");
          }
        })(Va),
        !qa.test(e))
      )
        return Va.cloneNode(!0);
      for (
        var t = document.createTreeWalker(Va, NodeFilter.SHOW_ELEMENT, null),
          n = [],
          r = t.nextNode();
        r;

      )
        $a(r) ? n.push(r) : Ja(r), (r = t.nextNode());
  ...
  function Za(e, t, n, r, a) {
    ...
    if (!La(t) || La(r)) return (e.textContent = t), (e.wgSetHTML = t), !0;
    var i = e.parentNode;
    if (!i)
      return (
        ga.warn(
  ...
  function to(e, t) {
    ...
    for (var i = 0; i < a.length; i++) {
      ...
      if ("text" === s.type) ro(s.nodes, l.nodes);
      else {
        var u = s.nodes[0],
          c = l.nodes[0];
  ...
  function so(e) {
    var t = [
      { type: 1, selectors: ["[title]"], attribute: ao("title") },
      {
        type: 2,
      ...
      },
      {
        ...
        attribute: ao("content"),
      },
      { type: 7, selectors: ["img"], attribute: ao("alt") },
      {
        type: 8,
    ...
    if (
      (e.media_enabled &&
        t.push(
          ...
          { type: 6, selectors: ["img"], attribute: ao("srcset") },
          { type: 6, selectors: ["video"], attribute: ao("src") },
          {
            type: 6,
            selectors: ["[style*='url']"],
            attribute: {
      ...
      var n = io(
        (function () {
          ...
          return a
            ? a[1]
            : (ga.warn("[Weglot] Unable to get current hostname"), t);
        })()
      );
      t.push(
        { type: 10, selectors: ["iframe"], attribute: ao("src") },
        { type: 10, selectors: ["a[rel=external]"], attribute: ao("href") },
        { type: 10, selectors: ['[href^="mailto"]'], attribute: ao("href") },
        { type: 10, selectors: ['[href^="tel"]'], attribute: ao("href") },
        {
          type: 10,
          ...
          attribute: {
            ...
            get: function (e) {
              ...
              return t && io(t) !== n ? e.getAttribute("href") : "";
            },
            set: function (e, t) {
  ...
  function uo(e, t) {
    ...
    return (
      ...
      (fa.mergeNodes =
        ...
        da.mergeNodesList.v2.unshift("#text", "#comment"),
        Object.keys(da.mergeNodesList).reduce(function (e, t, r) {
          return n >= r + 1 && [].push.apply(e, da.mergeNodesList[t]), e;
        }, []))),
      Array.isArray(fa.extra_merged_selectors) &&
        (fa.selectorMerging = t.extra_merged_selectors
          .filter(function (e) {
            return e && "string" == typeof e;
          })
          .join(",")),
      t.merged_selectors_remove &&
        (fa.mergedSelectorRemove = t.merged_selectors_remove
          .map(function (e) {
            return e.value;
          })
          .join(",")),
      { getTextNodes: Oa, setTextNodes: Qa, definitions: (lo = so(fa)) }
    );
  }
  function co(e, t, n) {
    var r;
    if (
      (void 0 === t && (t = Pe()),
      void 0 === n && (n = ea()),
      null === (r = null == e ? void 0 : e.to_words) || void 0 === r
        ? void 0
        : r.length)
    )
      for (
        var a = e.from_words, i = e.to_words, s = 0, l = n;
        s < l.length;
        s += 1
      ) {
        var u = l[s].weglot;
        if (null == u ? void 0 : u.content)
          for (var c = 0, d = u.content; c < d.length; c += 1) {
            var f = d[c],
              g = f.original,
              p = f.translations,
              h = a.indexOf(ye(g));
            if (-1 !== h && !p[t]) {
              var v = we(i[h]);
              te.prevent_retranslation && oa(v), (p[t] = v);
            }
          }
      }
    try {
  ...
  function fo(e) {
    if (!e) return "";
    if (e.nodeType === Node.TEXT_NODE) return fo(e.parentElement);
  ...
  try {
    Object.keys(vo).forEach(function (e) {
      Object.keys(vo[e]).forEach(function (t) {
        Object.keys(vo[e][t]).forEach(function (n) {
          _o[e] || (_o[e] = {}), _o[e][n] || (_o[e][n] = {});
          var r = vo[e][t][n];
          _o[e][n][r] = t;
        });
      });
  ...
  function yo(e, t) {
    return !(!_o[te.api_key] || !_o[te.api_key][t]) && _o[te.api_key][t][e];
  }
  function wo(e) {
    var t;
    return null === (t = vo[te.api_key]) || void 0 === t ? void 0 : t[e];
  }
  function bo() {
    try {
      po.setItem(go, JSON.stringify(ho)), po.setItem(F, JSON.stringify(vo));
    } catch (e) {}
  }
  var ko = Le(bo);
  function So(e, t) {
  ...
  var Eo = function (e) {
    void 0 === e && (e = "undefined" != typeof Set ? new Set() : null),
      (this.trackingId = 0),
      (this.pendingNodes = {}),
      (this.nativeSet = e);
  };
  (Eo.prototype.add = function (e) {
    this.nativeSet
      ? this.nativeSet.add(e)
      : (void 0 !== e.wgPendingId && this.pendingNodes[e.wgPendingId] === e) ||
        ((e.wgPendingId = this.trackingId++),
        (this.pendingNodes[e.wgPendingId] = e));
  }),
    (Eo.prototype.getAll = function () {
      var e = this;
      return this.nativeSet
        ? Array.from(this.nativeSet)
        : Object.keys(this.pendingNodes).map(function (t) {
            return e.pendingNodes[t];
          });
    }),
    (Eo.prototype.remove = function (e) {
      this.nativeSet
        ? this.nativeSet.delete(e)
        : void 0 !== e.wgPendingId &&
          (delete this.pendingNodes[e.wgPendingId], delete e.wgPendingId);
    }),
    (Eo.prototype.clear = function () {
      if (this.nativeSet) this.nativeSet.clear();
      else {
        for (
          var e = 0, t = Object.keys(this.pendingNodes);
          e < t.length;
          e += 1
        ) {
          var n = t[e];
          delete this.pendingNodes[n].wgPendingId;
        }
        (this.pendingNodes = {}), (this.trackingId = 0);
      }
    }),
    (Eo.prototype.parseAll = function () {
      for (var e = 0, t = this.getAll(); e < t.length; e += 1) {
        var n = t[e];
        (te.ignoreDynamicFragments && !n.isConnected) || ta(So(n));
      }
      this.clear();
    });
  var Lo = new Eo();
  function Ao(e) {
    return !!e && !e.startsWith("wg_");
  }
  function To(e) {
    var t = e.body,
      n = e.options,
      r = e.headers,
      a = e.logger,
      o = (n.versions && n.versions.translation) || 1,
      i = ["api_key=" + n.api_key, "v=" + o];
    Ao(n.api_key) && i.push("live=1");
    var s,
      l = n.api_domain || "cdn-api-weglot.com",
      u =
        (l.startsWith("http") ? l : "https://" + l) +
        "/translate?" +
        i.join("&"),
      c = Object.assign({}, r || {});
    return (
      n.previewHash && (c["weglot-source"] = "preview"),
      fetch(u, {
        method: "POST",
        body:
          ((s = JSON.stringify(t)),
  ...
  function Do() {
    var e = l();
    if (e) return delete e.settings, e;
  }
  function Mo(e, t, n) {
    if (!e) return !0;
    var r = e.type,
    ...
    if ("URI_MATCH" === r && Wo(t.url, a)) return !0;
    if ("HOST_MATCH" === r && Wo(t.hostname, a)) return !0;
    if ("TRANSLATION_URL_MATCH" === r && Wo(t.url, a)) return !0;
    if ("PATH_MATCH" === r && Wo(t.pathname, a)) return !0;
    if ("INTEGRATION" === r) {
      var o = Io(n);
    ...
    if ("DOM_CONTAINS" === r) {
      var i = a.selector;
      if (_e(document, i)) return !0;
    }
    return "IN_FRAME" === r
      ? a === ("with-window-top" === ke())
      : ("object" == typeof a &&
          "selector" in a &&
  ...
  var Wo = function (e, t) {
    if (!t || "object" != typeof t || !("type" in t) || !("value" in t))
      return !1;
    var n = t.type,
      r = t.value,
      a = Ie((e = e.toLocaleLowerCase()));
    return !(!a[n] || "function" != typeof a[n]) && a[n](r);
  };
  function zo(e, t) {
    if (!e || 0 === e.length) return !0;
    if (!Array.isArray(e)) return !1;
    for (var n = pe(), r = 0, a = e; r < a.length; r += 1) {
      var o = a[r];
      if (Array.isArray(o)) {
        if (
          o.every(function (e) {
          ...
          return !0;
      } else if (Mo(o, n, t)) return !0;
    }
    return !1;
  }
  function qo() {
    var e = (function () {
      if (te.visual_editor) return new ue(pe().url);
      var e = te.technology,
        t = te.injectedData;
      if (e === N) return new ue(window.location.href);
      if (t && t.originalCanonicalUrl)
        try {
          return new ue(t.originalCanonicalUrl);
        } catch (e) {}
      var n = document.querySelector("link[rel='canonical'][href]");
      if (n)
        try {
          return new ue(n.href);
        } catch (e) {}
      return new ue(window.location.href);
    })();
    te.disable_remove_numeric_slugs ||
    ...
    for (
      var t = 0,
        n = (function () {
          var e,
            t,
            n = Oo.filter(function (e) {
              return !(t = e.technology || e.title) || t === te.technology;
              var t;
            }).map(function (e) {
              return e.urls;
            }),
            r =
              (null === (t = te.definitions) || void 0 === t
                ? void 0
                : t.urls) || [];
          return (e = []).concat.apply(e, n.concat([r])).filter(function (e) {
            return zo(e.condition, te);
          });
        })();
      t < n.length;
      t += 1
      ...
      var r = n[t].value;
      try {
        for (var a = 0, i = r; a < i.length; a += 1) {
          var s = i[a],
            l = s.original,
            u = s.formatted,
            c = e.pathname.replace(new RegExp(l), u);
          if (c !== e.pathname) return (e.pathname = c), e.toString();
        }
      } catch (e) {
        o.warn(e, { consoleOverride: "Invalid URL regex, " + e.stack });
      }
    }
    return e.toString();
  }
  function Fo(e, t) {
    ...
    var n,
      ...
      a = e.l_to,
      i = e.words,
      s = te.visual_editor || t.search || te.disable_local_cache,
      l =
        !s &&
        ((n = ho[te.api_key]),
        (r = n && n === te.versions.translation) ||
          (delete vo[te.api_key],
          delete ho[te.api_key],
          delete _o[te.api_key],
          bo()),
        r),
      u =
        te.visual_editor && !Ao(te.api_key)
          ? Mt("cookie").getItem("wg-editor-session")
          : void 0,
      c = {};
    if ((u && (c["editor-session"] = u), !i || !i.length))
      ...
      var d = (function (e, t) {
          ...
          return {
            isComplete: e.every(function (e) {
              var a = wo(e.w);
              if (a && a[t]) return n.push(a[t]), r.push(ye(e.w)), !0;
            }),
        ...
        f = d.isComplete,
        g = d.words;
      if (f) return Promise.resolve(g);
    }
    return To({
      body: Object.assign({}, e, { l_to: re(a, te), request_url: qo() }),
      options: te,
      headers: c,
      logger: o,
    }).then(function (e) {
        ...
        s ||
          i.forEach(function (t, n) {
            ...
            (r = t.w),
              ...
              (u = wo(r))
                ? (u[i] = o)
                : (vo[l] || (vo[l] = {}), (vo[l][r] = (((s = {})[i] = o), s))),
              _o[l] || (_o[l] = {}),
              _o[l][i] || (_o[l][i] = {}),
              (_o[l][i][o] = r),
              te.versions &&
                te.versions.translation &&
                ((ho[l] = te.versions.translation), ko());
          }),
        e
      );
    });
  ...
  function Uo(e) {
    var t = e.words,
      ...
      r = e.languageFrom,
      a = e.opts;
    a = Object.assign({}, { title: !0, cdn: !1, search: !1 }, a);
    var o = { l_from: r || te.language_from, l_to: n, words: t };
    return a.title && (o.title = document.title), Fo(o, a);
  }
  function Ho(e, t) {
    Lo.parseAll();
    var n = sa(),
      r = document.documentElement.getAttribute("lang");
    return (
      document.documentElement.setAttribute("lang", e),
      Uo({ words: n, targetLanguage: e })
        .then(function (n) {
          te.wait_transition_dynamic || fe(),
            co(n, e),
            X("languageChanged", e, t || ""),
            te.loading_bar && Jr();
        })
        .catch(function (e) {
          throw (
  ...
  var Vo = {},
    $o = function (e, t) {
      Vo[e] || (Vo[e] = []), Vo[e].push(t);
    },
    Go = function (e, t) {
      if (Vo[e])
        for (var n = 0, r = Vo[e]; n < r.length; n += 1) {
          (0, r[n])(t);
        }
    };
  function Ko(e) {
    return (
      !((!te.is_connect && !ae(te.technology)) || Pe() === e) &&
      (!te.host ||
      (te.previewHash && window.location.hostname.includes(D)) ||
      (function () {
        if (te.subdirectory) return [te.host].concat(ie);
        return te.languages
          .map(function (e) {
            var t;
            return null === (t = e.connect_host_destination) || void 0 === t
              ? void 0
              : t.host;
          })
          .concat([te.host].concat(ie))
          .filter(Boolean);
  ...
  function Jo(e, t) {
    if (!ze().includes(e))
      return (
        fe(),
        void o.warn(e + " isn't a language you have added", {
          sendToDatadog: !1,
        })
      );
    (te.auto_switch || te.geo_auto_switch) && $r(e);
    var n = Me();
    if ((te.is_connect || n || Kr(e), !Ko(e))) {
      if (
        (te.loading_bar &&
          (function () {
            var e;
      ...
      if (e === te.language_from)
        return (
          Go("onPageLanguageSet", e),
          Bo(e),
          void X("languageChanged", e, t || "")
        );
      Ho(e, t), Go("onPageLanguageSet", e);
    }
  }
  var Xo = "wg_status_message";
  var Qo,
    Zo = null,
    Yo = !1;
  function ei(e) {
    if (null !== Zo && e === Zo) {
      ...
      var n = (function () {
        try {
          ...
          return (
            e ||
              (((e = document.createElement("div")).id = Xo),
      ...
      n &&
        ...
        (Qo = window.setTimeout(function () {
          var e;
          n.textContent = (en[(e = t)] || en[Zt[e]] || en.en)[1] + ": " + Qt(t);
        }, 100)));
    }
  }
  function ti(e) {
    var t = Pe();
    e !== t &&
      (te.announce_language_change &&
        (function (e) {
          (Zo = e), Yo || (Yo = J("languageChanged", ei, !1));
        })(e),
      te.visual_editor
        ? Kt(e, function (n) {
            if ("#" === n) return Jo(e, t);
  ...
  function ni(e) {
    return function (t) {
      t.preventDefault(), ti(e);
    };
  }
  function ri(e) {
    Ir.getDetectedLinks().forEach(function (t) {
      var n = t.language,
        r = t.links,
        a = n === e,
        o = a ? "add" : "remove",
      ...
      r.forEach(function (e) {
        e.classList[o]("weglot-link--active"),
          te.linkHooksConfig &&
            te.linkHooksConfig[i] &&
            te.linkHooksConfig[i](e);
      });
    });
  }
  function ai(e, t) {
    var n = Ir.findDetectedLink(e);
    (n && -1 !== n.links.indexOf(t)) ||
      (n ||
        ((n = { language: e, links: [], onLinkClick: ni(e) }),
        Ir.addDetectedLink(n)),
      t.setAttribute(W, ""),
      t.classList.add("weglot-link", "weglot-link-" + e),
      e === Pe() &&
        (t.classList.add("weglot-link--active"),
        te.linkHooksConfig &&
          te.linkHooksConfig.onLinkActive &&
          te.linkHooksConfig.onLinkActive(t)),
      Kt(e, function (e) {
  ...
  function oi(e) {
    ...
    if (
      ...
      return !1;
    for (var r = !1, a = 0, o = ze(); a < o.length; a += 1) {
      var i = o[a],
        s = ve(e, qr(i));
      if (s.length) {
        r = !0;
        for (var l = 0, u = s; l < u.length; l += 1) {
          ai(i, u[l]);
        }
      }
    }
    return (
      ...
      J("initialized", function () {
        var e = Pe();
        e !== te.language_from && ri(e);
      }),
      r
    );
  }
  function ii(e) {
    ...
    if (te.disable_dynamics_on_browser_translation) {
      var r =
          null ===
            (n =
  ...
  function si(e) {
    if (!e || !te.dynamicsSelector) return !1;
    if (!e.closest) return si(e.parentNode);
    var t = !!me(e, te.dynamicsSelector);
    if (!t) {
      var n = ui(e);
      if (n) return si(n);
    }
  ...
  function li(e) {
    ...
    for (var t = 0, n = te.dynamics || []; t < n.length; t += 1) {
      var r = n[t];
      if (me(e, r.value)) return r.value;
    }
    var a = ui(e);
    return a ? li(a) : "unknown";
  }
  function ui(e) {
    var t,
      n = null === (t = e.getRootNode) || void 0 === t ? void 0 : t.call(e);
    return (null == n ? void 0 : n.host) ? n.host : null;
  }
  function ci(e) {
    return (
      !!me(e, "[" + W + "]") ||
      (!!te.excludedBlocksSelector && !!me(e, te.excludedBlocksSelector))
    );
  }
  function di(e) {
  ...
  function fi(e) {
    ...
    var r = te.proxify_iframes,
      a = te.api_key,
      o = te.language_from;
    if (r && r.length && Array.isArray(r))
      for (var i = 0, s = ve(n, r.join(",")); i < s.length; i += 1) {
        var l = s[i],
          u = l.src;
        if (u)
          if (
            (l.weglot || (l.weglot = {}),
            u.includes(z + "/") || u.includes("/" + q + "/"))
          )
            if (t && t !== o) {
  ...
  function hi() {
    var e = ["name", "value"];
    te.translate_event &&
      te.translate_event.forEach(function (t) {
        for (
          var n = Array.from(ve(document.body, t.selector)),
            r = function () {
              var n = o[a];
              if (n.wgListeningEventInput)
                return (
                  !n.wgListeningEventInput.isConnected &&
                    pi < 10 &&
                    (pi++,
                    n.parentNode &&
                      n.parentNode.insertBefore(
                        n.wgListeningEventInput,
                        n.nextSibling
                      )),
                  {}
                );
              ...
              if (!r) return {};
              (r.name = ""),
                (n.wgListeningEventInput = r),
                n.parentNode && n.parentNode.insertBefore(r, n.nextSibling),
                (n.style.display = "none"),
                new MutationObserver(function (t) {
                  for (var a = 0, o = t; a < o.length; a += 1) {
                    var i = o[a];
                    if (i.attributeName) {
                      var s = n.getAttribute(i.attributeName);
  ...
  function mi(e) {
    ...
    _i.length &&
      (vi = setTimeout(function () {
        ...
        hi(),
          (function (e) {
            if (te.is_connect && Pe() !== te.language_from)
              for (var t = 0, n = e; t < n.length; t += 1) {
                var r = n[t],
                  a = Array.from(ve(r, "a[href]"));
                if ("A" === r.tagName) {
                  var o = r;
                  o.href && a.push(o);
                }
                      ...
                      t &&
                        ...
                        (e.hasAttribute("hreflang") ||
                          ...
                          ((!te.subdirectory ||
                            /^\/(?:[^/]|$)/.test(t) ||
                            t.includes("//" + te.host)) &&
                            (te.subdirectory || t.includes("//" + te.host)) &&
                            (Me(
                              void 0,
                              t.includes("//" + te.host)
                                ? t.split("//" + te.host)[1] || ""
          ...
          (null === (e = te.proxify_iframes) || void 0 === e
            ? void 0
            : e.length) &&
            _i.forEach(function (e) {
              return fi({ node: e });
            }),
          Go("onDynamicDetected"),
          (_i = []);
      }, 100));
  }
  var yi = [W, "class", "id"];
  var wi = { times: [], timeout: null, nodes: [] };
  function bi(e) {
    void 0 === e && (e = []),
      te.wait_transition_dynamic && ge(),
      wi.timeout && clearTimeout(wi.timeout);
    var t = Pe();
    if (t === te.language_from) return Promise.resolve();
    if (
      ((wi.times = wi.times.filter(function (e) {
        return e > Date.now() - 1e3;
      })),
      wi.times.length && (wi.timeout || wi.times.length >= 10))
    )
      return (
        (wi.nodes = wi.nodes.concat(e)),
        (wi.timeout = setTimeout(function () {
          return bi();
        }, 1e3)),
        Promise.resolve()
      );
    e.forEach(function (e) {
      e.translationLabel = "dynamic-selector: " + li(e);
    }),
      (wi.timeout = null),
      wi.times.push(Date.now());
    var n = wi.nodes.concat(e);
    return (
      (wi.nodes = []),
      Uo({
        words: sa(n, { label: "Dynamic" }),
        targetLanguage: t,
        opts: { title: !1, cdn: !0, nodes: n },
      }).then(function (e) {
        return co(e, t, n);
      })
    );
  ...
  function ki(e, t, n) {
    var r = e.outerHTML || e.textContent;
    if (e.wgSetHTML !== r)
      if (t(e)) Si(e, n);
      else {
        var a = te.dynamicsSelector;
        if (a)
          for (
            var o = (function (e, t) {
                try {
              ...
              i = function (e) {
                var r = o[e];
                if (t(r)) {
                  var a = Array.prototype.some.call(o, function (t, n) {
                    return n !== e && t.contains(r);
                  });
                  a || Si(r, n);
                }
              },
  ...
  function Si(e, t) {
    if (Pe() !== te.language_from)
      for (
        var n = So(e, function (e) {
            return !(function (e) {
              var t;
              if (
                (null === (t = e.weglot) || void 0 === t
                  ? void 0
                  : t.dynamic) &&
                e.weglot.dynamic > 20
              ) {
                if (e.wgBypassDynamicLimit) return !1;
                var n = te.dangerously_bypass_dynamic_limit;
                if (n) {
                  var r = e.closest ? e : e.parentNode;
                  if (me(r, n)) return (e.wgBypassDynamicLimit = !0), !1;
                }
                return !0;
              }
              return !1;
        ...
        var o = a[r];
        (te.ignoreDynamicFragments && !o.isConnected) ||
          (o.weglot.dynamic || (o.weglot.dynamic = 0),
          o.weglot.dynamic++,
          t.push(o));
      }
    else Lo.add(e);
  ...
  var xi = function () {
    (this.processedQueue = !1),
      (this.disconnected = !1),
      (this.mutationQueues = []),
      (this.observers = []);
  };
  (xi.prototype.setMutationQueues = function (e) {
    this.mutationQueues = e;
  }),
    (xi.prototype.getMutationQueues = function () {
      return this.mutationQueues;
    }),
    (xi.prototype.addObserver = function (e) {
      this.observers.push(e);
    }),
    (xi.prototype.addMutationsToQueue = function (e, t) {
      this.mutationQueues.push({ observedDocument: e, mutations: t });
    }),
    (xi.prototype.setObservers = function (e) {
      this.observers = e;
    }),
    (xi.prototype.getObservers = function () {
      return this.observers;
    }),
    (xi.prototype.setHasProcessedQueue = function (e) {
      this.processedQueue = e;
    }),
    (xi.prototype.setIsDisconnected = function (e) {
      this.disconnected = e;
    }),
    (xi.prototype.hasProcessedQueue = function () {
      return this.processedQueue;
    }),
    (xi.prototype.isDisconnected = function () {
      return this.disconnected;
    });
  var Ei = new xi();
  function Li(e, t) {
    var n = e === document;
    n && Ei.setIsDisconnected(!1);
    var r = (n && e.body) || e,
      a = new MutationObserver(function (n) {
        var r;
        if (Ei.hasProcessedQueue()) Ti(n, ii(!!t), !1);
        else {
          var a = Ei.getMutationQueues().find(function (t) {
            return t.observedDocument === e;
          });
          a
            ? (r = a.mutations).push.apply(r, n)
            : Ei.addMutationsToQueue(e, [].concat(n));
        }
      });
    a.observe(r, {
      childList: !0,
    ...
    t(e) &&
      (function (e) {
        ...
        try {
          ...
          return !!n && ((n[t] = "asd"), "asd" === n[t]);
        } catch (e) {
          return !1;
        }
      })(e) &&
      (ba(e) ||
        ((null === (r = e.contentWindow) || void 0 === r
          ? void 0
          : r.document) &&
          (ki(e.contentWindow.document, t, n),
          Li(e.contentWindow.document, !0))));
  }
  function Ti(e, t, n) {
    if (e.length && !Me())
      if (n) {
        var r = function () {
          var n = e.splice(0, 100);
          n.length && (Ci(n, t), setTimeout(r, 0));
        };
        r();
      } else Ci(e, t);
  }
  function Ci(e, t) {
    try {
      (e = (function (e, t) {
        for (
          var n = [],
            r = e.filter(function (e) {
              ...
              "attributes" === a &&
                ...
                (function (e) {
                  if ("IMG" === e.nodeName) {
                    var t = e;
                    t.srcset &&
                      t.dataset.wgtranslated &&
                      (t.setAttribute("wgsrcset", t.srcset), (t.srcset = ""));
                  }
                })(s));
              var l = (function (e) {
                do {
              ...
              if (l) return n.push(l), !1;
              if (null == i ? void 0 : i.length)
                for (var u = 0, c = i; u < c.length; u += 1) {
                  var d = c[u];
                  Lo.remove(d);
                }
        ...
        (function (e, t) {
          for (var n = [], r = [], a = 0, o = e; a < o.length; a += 1) {
            var i = o[a],
              s = i.type,
              l = i.target,
              u = i.addedNodes,
            ...
            switch (s) {
              ...
              case "characterData":
                ...
                break;
              case "childList":
                if (!(null == u ? void 0 : u.length)) break;
                var d = u.length > 1 ? c : u[0];
                if (r.includes(d)) break;
                ki(d, t, n), r.push(d);
                for (var f = 0, g = u; f < g.length; f += 1) {
                  var p = g[f];
                  if ("IFRAME" !== p.tagName) {
                    if ("querySelectorAll" in p && p.querySelectorAll)
                      for (
                        var h = 0, v = p.querySelectorAll("iframe");
                        h < v.length;
                        h += 1
                      )
                        Ai(v[h], t, n);
      ...
      o.warn(e, { consoleOverride: "Error in MutationObserver" });
    }
  }
  function Oi(e, t) {
    !te.is_connect || te.dynamicPushState || (!e && t !== te.language_from)
      ? (function () {
          Ei.isDisconnected() && Li(document);
          if ((Ei.setHasProcessedQueue(!0), !te.is_connect))
            return void Ei.setMutationQueues([]);
          for (var e = 0, t = Ei.getMutationQueues(); e < t.length; e += 1) {
            var n = t[e],
              r = n.mutations,
              a = n.observedDocument;
            Ti(r, ii(!!(a !== document && !d(a))), !0);
          }
        })()
      : ji();
  }
  function ji() {
    Ei.setIsDisconnected(!0);
    for (var e = 0, t = Ei.getObservers(); e < t.length; e += 1) {
      t[e].disconnect();
    }
    Ei.setObservers([]), Ei.setMutationQueues([]);
  }
  function Ni(e, t) {
  ...
  var Ri = {
    ai_disclaimer_selector: Wi,
    api_domain: Wi,
    api_key: Wi,
    language_from_custom_flag: Wi,
    language_from_custom_name: Wi,
    host: Wi,
    language_from: Wi,
    custom_css: Wi,
    url_type: Wi,
    technology: Wi,
    technology_name: Wi,
    auto_switch_fallback: Wi,
    cloudflare_resolve_override: Wi,
    fastly_origin_backend: Wi,
    dangerously_force_dynamic: Wi,
    search_forms: Wi,
    search_parameter: Wi,
    website: Wi,
    uid: Wi,
    language_to: Wi,
    override_hreflang: function (e, t) {
      if ("boolean" == typeof t) return t ? "all" : "none";
      return E.includes(t) ? t : void 0;
    },
    translate_iframes: qi,
    dynamic: qi,
    force_translation: qi,
    dangerously_bypass_dynamic_limit: qi,
    category: Mi,
    translation_engine: Mi,
    pageview_sample_rate: Mi,
    deleted_at: Mi,
    technology_id: Mi,
    auto_inject_script: Fi,
    use_template_integrity: Fi,
    auto_switch: Fi,
    allow_http: Fi,
    allow_render: Fi,
    customer_tag: Fi,
    order_tag: Fi,
    delayStart: Fi,
    disable_dynamics_on_browser_translation: Fi,
    client_translation_only: Fi,
    geo_auto_switch: Fi,
    fix_shopify_checkout_locale: Fi,
    shopify_skip_shop_pay: Fi,
    hide_switcher: Fi,
    hide_switcher_watermark: Fi,
    wait_transition: Fi,
    prevent_retranslation: Fi,
    index_with_trailing_slash: Fi,
    page_views_enabled: Fi,
    is_https: Fi,
    is_dns_set: Fi,
    media_enabled: Fi,
    external_enabled: Fi,
    multilingual_sitemap: Fi,
    override_csp: Fi,
    override_bot_agent: Fi,
    prevent_default_locale_rule: Fi,
    saas: Fi,
    translate_aria: Fi,
    announce_language_change: Fi,
    translate_images: Fi,
    ignoreDynamicFragments: Fi,
    ve_inject_library: Fi,
    ve_suggestions: Fi,
    disable_internal_proxy: Fi,
    disable_origin_ssl_verification: Fi,
    disable_remove_numeric_slugs: Fi,
    disable_local_cache: Fi,
    loading_bar: Fi,
    dangerously_enable_cross_domain_cookies: Fi,
    original_shopify_checkout: Fi,
    shopifyCheckout: Fi,
    translate_search: Fi,
    translate_amp: Fi,
    translate_email: Fi,
    dynamicPushState: Fi,
    remove_unused_link_hooks: Fi,
    translate_shadow_roots: Fi,
    disable_datadog_logging: Fi,
    squarespace_official_integration: Fi,
    shopify_theme_app_extension: Fi,
    shopify_extension_connected: Fi,
    squarespace_extension_connected: Fi,
    wix_extension_connected: Fi,
    squareonline_extension_connected: Fi,
    rendered: Fi,
    inject_weglot_css: Fi,
    wait_transition_dynamic: Fi,
    extra_merged_selectors: Bi,
    cart_attributes: Bi,
    proxify_iframes: Bi,
    excluded_blocks_remove: Bi,
    dynamics_remove: Bi,
    shadow_roots_selectors: Bi,
    merged_selectors_remove: Hi,
    translate_inside_exclusions: Hi,
    whitelist: Hi,
    dynamics: Hi,
    excluded_blocks: Hi,
    switchers: Ui,
    ...
    translate_event: Ui,
    localeRules: Ui,
    locale_rules_regex: Ui,
    excluded_attributes: Ui,
    extra_definitions: Ui,
    excluded_paths: Ui,
    http_monitoring: zi,
    button_style: zi,
    versions: zi,
    service_worker: zi,
    network_overrides: zi,
    definitions: zi,
  };
  function Pi(e) {
    var t = {};
    ...
    var n = (function (e) {
      var t = e.technology,
        n = e.technology_name,
        r = e.technology_id;
      return t || n || P[Number(r)];
    })(t);
    return (
      n && (t.technology = n),
      t.custom_settings && (t.custom_settings = Ii(t.custom_settings, t)),
      t
    );
  }
  function Ii(e, t) {
    var n = e.search_forms,
      r = e.search_parameter,
      a = e.translate_search,
      o = e.translate_shadow_roots,
      i = e.translate_forms;
    void 0 === i && (i = []);
    var s = e.shadow_roots_selectors,
      l = Object.assign({}, e);
    return (
      n &&
        r &&
        a &&
        (i.push({ selector: n, parameter: r }),
        delete l.search_forms,
        delete l.search_parameter,
        delete l.translate_search,
        (l.translate_forms = i)),
      o &&
        !s &&
        (null == t ? void 0 : t.dynamics) &&
        (l.shadow_roots_selectors = t.dynamics.map(function (e) {
          return e.value;
        })),
      l
    );
      ...
      switch (e) {
        case "http_monitoring":
          ...
          return (
            ...
            ["include", "exclude"].forEach(function (e) {
              Array.isArray(t[e]) && (n[e] = t[e].map(Mi).filter(Boolean));
            }),
            n
          );
        case "button_style":
        ...
        case "network_overrides":
          ...
          return {
            fetch: !!i.fetch,
            xhr: !!i.xhr,
            hooks: i.hooks.map(Vi).filter(Boolean),
          };
        case "versions":
          var s = t;
          return (
        ...
        case "definitions":
          ...
          if (!u || !Array.isArray(u))
            return Object.assign({}, l, { urls: void 0 });
          var c = u
            .map(function (e) {
  ...
  function $i(e) {
    if ("object" == typeof e) {
      var t = e.action_type,
        n = e.key;
      if (t && x.includes(t) && n && "string" == typeof n) {
        if ("parse_child" !== t) return { key: e.key, action_type: t };
        var r = e.child_parser,
          a = e.child_actions;
        if (r && A.includes(r) && a && Array.isArray(a)) {
          var o = a.map($i).filter(Boolean);
    ...
    var t = Object.keys(e).reduce(function (t, n) {
      var r = (function (e, t) {
            ...
            value: r
              ? n.map(function (e) {
                  return (
                    ...
                    (a = t.target),
                    (o = t.sibling),
                    { style: Ki(n, r), location: { target: a, sibling: o } }
                  );
                  var t, n, r, a, o;
                })
              : n,
        ...
        var a = [
          ...
          { from: "excludePaths", to: "excluded_paths", func: No },
          { from: "exceptions", to: "excluded_blocks", func: Ro },
          { from: "whiteList", to: "whitelist", func: Ro },
          { from: "styleOpt", to: "button_style", func: Ki },
          { from: "destinationLanguages", to: "languages", func: jo },
        ].find(function (t) {
          return t.from === e;
        });
        if (a) {
  ...
  function Ki(e, t) {
    if ((void 0 === t && (t = ""), !e)) return V.button_style;
    var n = e.classF || "",
      r = n.match(/flag-(\d)/),
      a = r && r[1],
      o = {
  ...
  function Ji(t) {
    var n, r;
    X("onOptionsReady"),
      t.custom_css && u(t.custom_css, "weglot-custom-style"),
      t.inject_weglot_css &&
        ((n = "https://cdn.weglot.com/weglot.min.css?v=11"),
        ((r = document.createElement("link")).rel = "stylesheet"),
        (r.type = "text/css"),
        (r.href = n),
        document.head.appendChild(r)),
      e(function () {
        t.injectedData || ne({ injectedData: Do() });
      });
  }
  function Xi(e) {
    for (
      ...
      var r = n[t];
      r.setAttribute("href", Ee(r.getAttribute("href"), "lang", e));
    }
  }
  function Qi(e, t) {
    var n = t;
  ...
  function Yi(e) {
    var t =
      "/checkout?locale=" +
      e +
      (te.shopify_skip_shop_pay ? "&skip_shop_pay=true" : "");
    fetch(t)
      .then(function (e) {
          ...
          u = function () {
            ...
            if (
              ...
              for (var l = 0, u = r; l < u.length; l += 1) {
                var f = u[l];
                o = Ee(o, f.name, f.value);
              }
              e.setAttribute(a, o),
                e.wgCheckoutListener &&
                  e.removeEventListener(s, e.wgCheckoutListener),
                t !== te.language_from &&
                  te.fix_shopify_checkout_locale &&
                  ((e.wgCheckoutListener = function (e) {
                    return (
                      e.preventDefault(),
                      e.stopPropagation(),
                      te.is_connect && !te.subdirectory
                        ? (Mt("cookie").setItem("wg_checkout_redirect", t),
                          (document.location.href = encodeURI(
                            (te.is_https ? "https:" : "http:") + "//" + te.host
                          )))
                        : Yi(n),
                      !1
                    );
      ...
      o =
        ...
        document.querySelector(
          'form[action="' +
            ((t = a),
            (n = "/account"),
            (te.is_connect && t !== te.language_from
              ? Zi[n]
                ? Zi[n]
                : (Ht(function (e) {
                    var a = e && e[t] ? Vt(n, e[t].original) : n;
                    r = te.subdirectory
                      ? Oe().convertLocale(t, a, te.language_from)
                      : a;
                  }),
                  (Zi[n] = r),
                  r)
        ...
        ("string" == typeof te.customer_tag && _e(document, te.customer_tag));
    if (o) {
  ...
  function ns(e) {
    ...
    t &&
      Pt.set({ name: "checkout_locale", value: rs(e), path: t, options: te });
  }
  function rs(e) {
    var t = {
      br: "pt-BR",
  ...
  function os() {
    ...
    if (e) {
      ...
      (1 !== t.length && t[0] === t[1]) ||
        Pt.set({ name: "cart", value: t[0], domain: as(), options: te });
    } else setTimeout(os, 100);
  }
  function is(e) {
    var t = e || Pe();
    if (!te.visual_editor && !ke()) {
      var n = te.cart_attributes,
        r = te.is_connect,
        a = te.original_shopify_checkout,
        o = te.subdirectory,
        i = te.language_from,
        s =
          Mt("cookie").getItem("cart") &&
          decodeURIComponent(Mt("cookie").getItem("cart") || ""),
        l =
          Mt("session").getItem("wg-cart-update-token") &&
          decodeURIComponent(
            Mt("session").getItem("wg-cart-update-token") || ""
          ),
        u = Mt("session").getItem("wg-cart-update-lang");
      if (n && n.length && (u !== rs(t) || s !== l)) {
        var c = n
            .map(function (e) {
              return "attributes[" + e + "]=" + rs(t);
            })
            .join("&"),
        ...
        !1 !== a &&
          ...
          Mt("session").setItem("wg-cart-update-token", s),
          Mt("session").setItem("wg-cart-update-lang", rs(t));
      }
      for (
        ...
        if (_) {
          var m = _.match(/\/cart\/\d+:\d+(\?)?/);
          m &&
            ((_ = _.replace(/&?attributes\[lang\]=([a-zA-Z-]+)/g, "")),
            v.setAttribute("href", _ + (m[1] ? "&" : "?") + g));
        }
      }
    }
  }
  function ss(e) {
    if (te.language_from !== e) {
      window.Shopify &&
        ((window.Shopify.locale = e), !Se() && te.order_tag && is(e)),
        es(e),
        ns(e);
      var t = document.querySelectorAll("[data-wg-only-display]");
      t.length && Qi(Array.from(t), e), te.customer_tag && ts(e);
    }
  }
  function ls() {
    !1 !== te.original_shopify_checkout &&
      te.is_connect &&
      !te.subdirectory &&
      te.language_from === Pe() &&
      os();
  ...
  function us() {
    var e = Mt("cookie").getItem("wg_checkout_redirect");
    e &&
      (Mt("cookie").removeItem("wg_checkout_redirect"),
      Mt("cookie").setItem("wg_checkout_language", e),
      Yi(e)),
      window.langify &&
        o.log("%c Please, uninstall langify to properly use Weglot", {
          sendToDatadog: !1,
        }),
      !window.Shopify ||
        Se() ||
        !te.order_tag ||
        (te.is_connect && te.language_from !== Pe()) ||
        is(),
      es();
    var t,
      n = document.querySelectorAll("[data-wg-only-display]");
    n.length && Qi(Array.from(n)),
      te.customer_tag && ts(),
          ...
          if ("/wallets/checkouts.json" === arguments[0])
            try {
              ...
              (e.checkout.attributes = {}),
                te.cart_attributes &&
                  te.cart_attributes.forEach(function (t) {
  ...
  function ps() {
    var e, t;
    try {
      var n = window.ExtensionScriptsSDK;
      if (!n) return;
      var r =
        null ===
          (t = null === (e = n["1.0"]) || void 0 === e ? void 0 : e.page) ||
        void 0 === t
          ? void 0
          : t.events;
      r && r.dispatchScriptLoadEvent("Weglot");
    } catch (e) {}
  }
  function hs() {
    var e = new MutationObserver(vs),
      t = document.getElementById("SITE_CONTAINER");
    t &&
      e.observe(t, {
        attributes: !0,
  ...
  function vs(e) {
    for (var t = 0; t < e.length; t++) {
      "SUCCESS" === e[t].target.getAttribute("data-santa-render-status") &&
        (this.disconnect(), X("start"));
    }
  }
  function _s(e, t, n) {
    void 0 === t && (t = 40), void 0 === n && (n = 100);
    var r = 0,
      a = setInterval(function () {
        ((document.body && window.sssr) || r >= t) && (clearInterval(a), e()),
          r++;
      }, n);
    return a;
  }
      ...
      if (t) {
        ...
        if (n) {
          ...
          if (a && l) {
            var u = a.src,
              c = a.srcset;
            (a.src = l.src), (a.srcset = l.srcset), (l.src = u), (l.srcset = c);
          }
          if (r && s) (r.textContent = s.textContent), (s.textContent = o);
          else {
            var d = n.textContent;
  ...
  function ws(e) {
    e && (e.classList.remove("w--current"), e.removeAttribute("aria-current"));
  }
  J(
    "onCurrentLocationChanged",
    function () {
  ...
  var bs = [".weglot-switcher-component a[lang]"];
  function ks() {
  ...
  var Ss = [
    ...
    },
    {
      ...
      settings: [
        {
          name: "Framer default settings for all pages",
          value: [{ type: "dynamics", payload: [{ value: "body" }] }],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      settings: [
        {
          name: "Lovable default settings for all pages",
          value: [{ type: "dynamics", payload: [{ value: "body" }] }],
        },
      ],
    },
      ...
      settings: [
        {
          ...
          value: [{ type: "excluded_blocks", payload: [{ value: ".price" }] }],
        },
      ],
    },
    {
      ...
      settings: [
        {
          ...
          value: [
            ...
            { type: "cart_attributes", payload: ["lang", "Invoice Language"] },
            {
              type: "excluded_blocks",
              payload: [
        ...
        },
        {
          ...
          value: [{ type: "dynamics", payload: [{ value: "#payment-form" }] }],
        },
        {
      ...
      settings: [
        ...
        },
        {
          ...
          value: [
            ...
            { type: "excluded_blocks", payload: [{ value: ".comment-body" }] },
            {
              type: "force_translation",
              payload: ["form [data-dynamic-strings]"],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          value: [
            ...
            { type: "enable_in_place_setters", payload: !0 },
          ],
        },
        {
          ...
          value: [
            ...
            { type: "force_translation", payload: ["#order-status-page-root"] },
          ],
        },
        {
  ...
  function xs(e, t) {
    var n = Ss.find(function (e) {
      return (e.technology || e.title) === t.technology;
    });
    return (
      n &&
        n.settings &&
              ...
              !(function (e, t, n) {
                ...
                void 0 !== r
                  ? Array.isArray(r) && Array.isArray(n)
                    ...
                    ? (e[t] = n.concat([r.split(",")]))
                    : (e[t] =
                        "object" != typeof r ? n : Object.assign({}, r, n))
                  : (e[t] = n);
              })(e, t.type, t.payload);
            });
          }),
  ...
  (Es[C] = function () {
    return (
      $o("onWeglotSetup", ls),
      J("initialized", us, !0),
      $o("onConnectPageLoad", cs),
      $o("onPageLanguageSet", ds),
      $o("onDynamicDetected", fs),
      $o("startWhen", gs),
      {}
    );
  }),
    (Es[O] = function () {
      return $o("onPageLanguageSet", Xi), {};
    }),
    (Es[j] = function () {
      return (
        J("initialized", ps),
    ...
    (Es[R] = function () {
      return (
        J("switchersReady", ks),
        {
          ...
          linkHooksConfig: {
            additionalCheckSelectors: bs,
            buildAdditionalSelectors: ms,
            onLinkActive: ys,
            offLinkActive: ws,
          },
        }
  ...
  function As(e) {
    var t = (function (e) {
        return e.technology
          ? xs(Es[e.technology] ? Es[e.technology]() : {}, e)
          : {};
      })(e),
      n = Object.assign({}, V, t),
      r = {};
  ...
  function Ts(e) {
    ...
    if (
      (o
        ? ((a.previewHash = o),
          (a.private_mode = !0),
          window.location.hostname.startsWith("front-")
            ? ((a.is_connect = !1), (a.subdirectory = !1), (a.is_dns_set = !1))
            : ((a.is_connect = !0),
              (a.subdirectory = window.location.hostname.startsWith("subdir-")),
              (a.is_dns_set = !0)))
        : (Po(e) && (a.subdirectory = !0),
          (a.is_connect = a.subdirectory || Io(e)),
          (a.private_mode = !!Dr()),
          se(window.location.hostname) &&
            (window.location.hostname.includes("switchers") &&
              (a.switcher_editor = !0),
            (a.visual_editor = !0)),
          a.forceDisableConnect && (a.is_connect = !1)),
      (a.custom_css =
        a.custom_css || (a.button_style && a.button_style.custom_css) || ""),
      a.switchers && a.switchers.length
        ? (a.switchers = a.switchers.map(function (e) {
        ...
        : (a.switchers = [
            {
              style: a.button_style || {},
              location: { target: "", sibling: "" },
              default: !0,
            },
          ]),
      a.api_key.length < 36 && (a.translation_engine = 1),
      a.dangerously_force_dynamic &&
        (a.dynamics = a.dynamics.concat(
          (a.dangerously_force_dynamic || "").split(",").map(function (e) {
            return { value: e.trim() };
          })
        )),
      a.dynamic &&
        ((a.dynamics = a.dynamics.concat(
          a.dynamic.split(",").map(function (e) {
            return { value: e.trim() };
          })
        )),
        delete a.dynamic),
      a.dynamics_remove &&
        (a.dynamics = a.dynamics.filter(function (e) {
          return !a.dynamics_remove.includes(e.value);
        })),
      a.excluded_blocks_remove &&
        (a.excluded_blocks = a.excluded_blocks.filter(function (e) {
          return !a.excluded_blocks_remove.includes(e.value);
        })),
      (a.excluded_blocks = a.excluded_blocks.filter(function (e) {
        return xe(e.value);
      })),
      ...
      (a.is_tld = !1),
      a.is_connect && !a.previewHash)
    ) {
      var i = a.host.split("www.").pop();
      a.is_tld = a.languages.some(function (e) {
        if (e.connect_host_destination && e.connect_host_destination.host)
          return !!i && -1 === e.connect_host_destination.host.indexOf(i);
      });
    }
    return (
      (a.prevent_retranslation =
        a.prevent_retranslation ||
        a.dynamics.some(function (e) {
          return "body" === e.value;
        })),
      a.is_connect &&
      !a.disable_internal_proxy &&
      window.location.hostname !== m
        ? (a.proxyFormat = k)
        : (a.proxyFormat = S),
      void 0 === a.disable_dynamics_on_browser_translation &&
        1 === a.category &&
        (a.disable_dynamics_on_browser_translation = !0),
      (a.excludedBlocksSelector =
        (null === (t = a.excluded_blocks) || void 0 === t
          ? void 0
          : t
              .map(function (e) {
                return e.value;
      ...
      (a.dynamicsSelector =
        (null === (n = a.dynamics) || void 0 === n
          ...
          : n
              ...
              .join(",")) || ""),
      (a.shadowRootsSelector =
        (null === (r = a.shadow_roots_selectors) || void 0 === r
          ? void 0
          : r.join(",")) || ""),
      (a.injectedData = Do()),
      a
  ...
  function Cs(e) {
    ...
    if (t && t.settings) {
      var n = t.settings,
        ...
        a = r;
      return (n.injectedData = a), Promise.resolve(Pi(n));
    }
    return fetch(
      (function (e) {
        if (e.startsWith("wg_"))
          return (
            "https://cdn.weglot.com/projects-settings/" + e.slice(3) + ".json"
          );
        return I + "?api_key=" + e;
      })(e)
    )
  ...
  function Ms(e) {
    return e.indexOf("weglot_script_tag") > -1;
  }
  function Ws() {
    var e = ze();
    if (te.is_connect)
      return (function (e) {
        var t =
          ...
          (te.subdirectory ? Ne() : je());
        if (t !== te.language_from) return t;
        if (te.technology === C) {
          var n = (function () {
            if (Pt.get("wg_checkout_redirect")) return te.language_from;
            var e = Pt.get("wg_checkout_language");
            return e && !te.shopifyCheckout && !ke() && ze().includes(e)
              ? (Pt.erase({ name: "wg_checkout_language", options: te }), e)
              : void 0;
          })();
          if (n) return n;
        }
        var r = Vr();
        if (t === te.language_from && r && e.includes(r)) return r;
        return te.language_from;
      })(e);
    var t = be("lang");
    if (t && e.includes(t)) return Ds(!0), t;
    if (te.language_to && e.includes(te.language_to)) return te.language_to;
    if (ae(te.technology))
      return (function (e) {
        var t = Re();
        if (t === te.language_from) {
          var n = Vr();
          if (n && e.includes(n)) return Ds(!0), n;
        }
        return t || te.language_from;
      })(e);
    var n = Gr();
    if (n && e.includes(n)) return n;
    var r = Vr();
    return r && e.includes(r) ? (Ds(!0), r) : te.language_from;
  }
  var zs = !1;
  function qs(e, t) {
    if (
      te.shadowRootsSelector &&
      (!te.is_connect ||
        te.dynamicPushState ||
        (!e && t !== te.language_from)) &&
      !zs
    ) {
      (zs = !0),
        (function () {
          try {
            ...
            Element.prototype.attachShadow = function (t) {
              var n = e.call(this, t);
              return ar(this, te.shadowRootsSelector) && Fs([this]), n;
            };
          } catch (e) {}
        })(),
        Fs(ve(document, te.shadowRootsSelector));
      var n = new MutationObserver(function (e) {
        for (var t = 0, n = e; t < n.length; t += 1) {
          var r = n[t],
            a = r.addedNodes,
            o = r.target;
          if ("childList" === r.type && (null == a ? void 0 : a.length))
            if (ar(o, te.shadowRootsSelector)) Fs([o]);
            else if (rr(o, te.shadowRootsSelector))
              for (var i = 0, s = a; i < s.length; i += 1) {
                var l = s[i],
                  u = l;
                nr(u, te.shadowRootsSelector)
                  ? Fs([l])
                  : Fs(ve(u, te.shadowRootsSelector));
              }
        }
      });
  ...
  function Fs(e) {
    if (null == e ? void 0 : e.length)
      for (var t = 0, n = e; t < n.length; t += 1) {
        var r = n[t];
        if (r.shadowRoot) {
          var a = So(r.shadowRoot);
          a.length && (ta(a), bi(a)),
            r.shadowRoot.wgTranslated ||
              ((r.shadowRoot.wgTranslated = !0), Li(r.shadowRoot, !0));
        }
      }
  }
  var Us = [],
  ...
  function Bs(e) {
    void 0 === e && (e = Pe()),
      (function (e) {
        ...
        for (
          var t,
            n = { message: "Weglot.setLanguage", payload: e },
            r = 0,
            a = Us;
          r < a.length;
          r += 1
    ...
    if (e.data && "null" !== e.origin) {
      ...
      if (n) {
        if ("Weglot.iframe" === n) {
          var a = e.source;
          Hs.set(a, e.origin);
          var o = { message: "Weglot.setLanguage", payload: Pe() };
          return a.postMessage(o, e.origin), void Us.push(a);
        }
        "Weglot.setLanguage" !== n || ti(r);
      }
    }
  }
  function $s() {
      ...
      window[e] = (function (e, t) {
        return function () {
          ...
          if ("string" == typeof n[0]) {
            var a = Pe();
            if (te.language_from === a) return t.apply(window, n);
            var o = [{ t: 2, w: n[0] }];
            return (
              "prompt" === e &&
                "string" == typeof n[1] &&
                o.push({ t: 2, w: n[1] }),
              Uo({ words: o, targetLanguage: a, opts: { title: !1, cdn: !0 } })
                .then(function (r) {
                  return (
                    (n[0] = r.to_words[0]),
                    "prompt" === e &&
  ...
  function Gs() {
    var e = Ir;
    e.getAlreadyAddedSwitcher() || X("switchersReady", Pe()),
      e.setAlreadyAddedSwitcher(!0),
      Ks();
  }
  function Ks() {
    var e = Ir.getDefaultSwitcherTimeout();
    e && (clearTimeout(e), Ir.setDefaultSwitcherTimeout(null));
    var t = Ir.getDefaultSwitcher();
    t && (c(t), Ir.setDefaultSwitcher(null));
  }
  function Js() {
    var e = Ir;
    e.getLangSwitchers().forEach(function (e) {
      ...
      (function () {
        for (
          ...
          null ===
            (n =
              null === (t = r[o[a]]) || void 0 === t
                ? void 0
                : t.removeSwitchers) ||
            void 0 === n ||
            n.call(t);
      })(),
      e.clearLangSwitchers(),
      e.setAlreadyAddedSwitcher(!1),
      (te.button_style.ready = !1),
      te.switchers.map(function (e) {
        return (e.ready = !1);
      });
  }
  function Xs(e, t) {
    if (
      ...
      var n = e.isConnected ? e : document;
      oi(n) && Gs(),
        (function (e) {
          var t,
            n,
          ...
          for (var a = !1, i = 0, s = r; i < s.length; i += 1) {
            var l = s[i],
              u =
                null === (t = l.dataset) || void 0 === t ? void 0 : t.template,
              d = u && Fr(u);
            if (!u || d) {
              if (d && "default" !== u)
                Mr(d, e).then(function () {
                  Gs();
                });
              else {
                var f = Rr({ style: te.button_style });
                f.classList.add("weglot_here"),
                  null === (n = l.parentNode) ||
                    void 0 === n ||
                    n.insertBefore(f, l),
                  c(l);
              ...
              var g = "Switcher template " + u + " not supported.";
              o.warn(g, { sendToDatadog: !1 });
            }
          }
          return a;
        })(n) && Gs();
      for (var r = 0, a = te.switchers; r < a.length; r += 1) {
        var i = a[r];
        if (!i.default) {
          var s = i.template;
          if (s && "default" !== s.name) {
      ...
      if (!(u = Ir).getAlreadyAddedSwitcher() && !u.getDefaultSwitcher()) {
        var u,
          d = te.switchers.find(function (e) {
            return e.default;
          }) || {
            style: te.button_style || {},
            location: { target: "", sibling: "" },
          },
          f = setTimeout(function () {
            var e = zr(d);
            e && Ir.setDefaultSwitcher(e), X("switchersReady", Pe());
          });
        Ir.setDefaultSwitcherTimeout(f);
      }
    }
  }
  var Qs = null;
  function Zs() {
    el().length &&
      (Ys(),
      (Qs = new MutationObserver(function (e) {
        if (el().length)
          for (var t = 0, n = e; t < n.length; t += 1) {
            var r = n[t],
              a = r.target,
      ...
      Qs.observe(document, { childList: !0, subtree: !0 }));
  }
  function Ys() {
    Qs && (Qs.disconnect(), (Qs = null));
  }
  function el() {
    var e;
    return (
      (null === (e = te.switchers) || void 0 === e
        ? void 0
        : e.filter(function (e) {
            return !(
              e.ready ||
              e.default ||
              (e.template && "default" !== e.template.name)
            );
          })) || []
    );
  }
  J("switchersReady", function () {
    !(function () {
      if (window.parent === window) return;
      sl(window.parent, { name: tl, type: "ASK_PARENT_SWITCHERS" }, nl);
    })(),
      il();
  });
  var tl = "weglot-switchers",
    nl = null,
    rl = new Map();
  function al(e) {
    if (
      ...
      (function (e) {
        if (!e) return !1;
        if (e === window.parent) return !0;
        for (var t = 0, n = ol(); t < n.length; t += 1)
          if (n[t].contentWindow === e) return !0;
        return !1;
      })(e.source)
    ) {
      var t = e.data,
      ...
      if ("weglot-switchers" === r)
        switch (n) {
          case "ASK_PARENT_SWITCHERS":
            e.source && rl.set(e.source, e.origin), il();
            break;
          case "ALERT_CHILD_SWITCHERS":
            if (((nl = e.origin), !a)) return;
            Js(), il(!0);
        }
    }
  }
  function ol() {
    return Array.from(ve(document.body, "iframe"));
  }
  function il(e) {
    for (var t, n = 0, r = ol(); n < r.length; n += 1) {
      var a = r[n],
        o =
          a.contentWindow &&
          null !== (t = rl.get(a.contentWindow)) &&
          void 0 !== t
            ? t
            : void 0;
      sl(
        a.contentWindow,
        { name: tl, type: "ALERT_CHILD_SWITCHERS", payload: e || Wr() },
        o
      );
    }
  }
  function sl(e, t, n) {
    e && e.postMessage(t, null != n ? n : "*");
  }
  var ll = (function () {
    var e = function (e, t) {
    ...
    var n = t,
      ...
      h = function () {
        ...
        b.addEventListener("error", k),
          ...
          (b.status = 0);
        for (var S = 0, x = Array.from(o.concat(a)); S < x.length; S += 1) {
          var E = x[S];
          b["on" + E] = null;
        }
        if (
  ...
  function dl(e, t) {
    ...
    if (r === a || Me()) t();
      ...
      var o = e.url,
        i = n.filter(fl).find(function (e) {
          return ul(o, e.url_wildcard);
        });
      if (i)
        return (function (e, t, n) {
          var r = t.target_source,
            ...
            i = {
              url_query: function (t, n) {
                return (
                  void 0 === n && (n = e.url),
                  {
                    ...
                    setter: function (r) {
                      var a = new ue(n, "https://" + window.location.hostname);
              ...
              url_encoded_form_payload: function (t, n) {
                void 0 === n && (n = e.body);
                var r = new ue("https://unused.com?" + n).searchParams;
                return {
                  word: r.get(t),
                  setter: function (a) {
                    r.set(t, a);
  ...
  (cl.prototype.handle = function (e, t) {
    if ((void 0 === t && (t = !1), !this.options.is_connect)) return e;
    var n = "/" === e.slice(0, 1) && "//" !== e.slice(0, 2),
      r = Br(e, "https://unused.com");
    if (!r) return e;
    var a = r.host,
      o = r.pathname;
    return n || this.isValidHost(a)
      ? (t
          ? ((r.pathname = this.reverseHandlePath(o)),
            (r.host = this.reverseHandleHost(a)))
          : ((r.pathname = this.handlePath(o)), (r.host = this.handleHost(a))),
        n ? "" + r.pathname + r.search + r.hash : r.toString())
      : e;
  }),
    (cl.prototype.isValidHost = function (e) {
      var t;
      return (
        e === this.options.host ||
    ...
    (cl.prototype.proxify = function (e) {
      var t = Br(this.location),
        n = "/" === e.slice(0, 1),
        r = n && "//" !== e.slice(0, 2);
      if (r && !t) return e;
      if (!n && !Br(e)) return e;
    ...
    (cl.prototype.reverseHandlePath = function (e) {
      var t = this.convertSlugsToOriginal(e);
      return this.options.subdirectory
        ? new Ce({ pathname: t, options: this.options }).convertLocale(
            this.options.language_from,
            t
          )
        : t;
    }),
    (cl.prototype.handlePath = function (e) {
      var t = this.convertSlugsToTranslated(e);
      return this.options.subdirectory
        ? new Ce({ pathname: t, options: this.options }).convertLocale(
            this.language,
            t
    ...
    (cl.prototype.reverseHandleHost = function (e) {
    ...
    (cl.prototype.handleHost = function (e) {
      var t,
        n = this;
      if (this.options.subdirectory) return e;
      if (e !== this.options.host) return e;
      var r = this.options.languages.find(function (e) {
        return e.language_to === n.language;
      });
      return (
        (r &&
          (null === (t = r.connect_host_destination) || void 0 === t
            ? void 0
            : t.host)) ||
        e
      );
    }),
    (cl.prototype.convertSlugsToOriginal = function (e) {
      var t;
      if (
        !this.language ||
    ...
    (cl.prototype.convertSlugsToTranslated = function (e) {
      var t;
      if (
        !this.language ||
        !(null === (t = this.slugs) || void 0 === t ? void 0 : t[this.language])
        ...
        return e;
      var n = this.slugs[this.language].original;
      return (
        void 0 === n && (n = {}),
        e
          .split("/")
  ...
  var gl = !1;
  function pl(e) {
    var t = te.service_worker;
    if (t && t.enabled && "serviceWorker" in navigator) {
      var n = navigator.serviceWorker;
      n.getRegistration()
        .then(function (e) {
          if (!e) return n.register(t.path_override || "/wg-sw.js");
        })
        .then(function () {
          return n.ready;
        })
        ...
        .then(function () {
          (gl = !0),
            Ht(function (t) {
              hl({ type: w, data: { slugs: t, language: e, options: te } });
            });
        })
        .catch(function () {});
    }
  ...
  (vl.prototype.setNeedsSerialization = function () {
    ...
    (vl.prototype.extractBody = function (e) {
      try {
        this._extractBody(e);
      } catch (t) {
        throw (
    ...
    (vl.prototype.serialize = function () {
  ...
  var yl = (function (e) {
      ...
      return (
        ...
        (t.prototype._parse = function () {
          ...
          for (var e = 0, t = this.actions; e < t.length; e += 1)
            for (
              var n = t[e], r = n.key, a = 0, o = ml(this.parsed, r);
              a < o.length;
              a += 1
            ) {
              var i = o[a],
    ...
    wl = (function (e) {
      ...
      return (
        ...
        (t.prototype.constructor = t),
        (t.prototype._parse = function () {
          var e = this.contentString.match(/^[^#]*\?([^#]*)/);
          if (e) {
            (this.queryStartIndex = e.index + e[0].indexOf("?") + 1),
              (this.queryEndIndex = this.queryStartIndex + e[1].length),
              (this.parsed = new URL("https://www.example.com?" + e[1]));
            for (var t = 0, n = this.actions; t < n.length; t += 1) {
              var r = n[t],
                a = this.parsed.searchParams.get(r.key);
              a && this.applyAction(r.key, a, r);
            }
          }
        }),
        (t.prototype._set = function (e, t) {
        ...
        (t.prototype._serialize = function () {
          if (!this.parsed) return this.contentString;
          var e = this.parsed.searchParams.toString();
          return (
            this.contentString.substring(0, this.queryStartIndex) +
            e +
            this.contentString.substring(this.queryEndIndex)
          );
        }),
        t
      );
  ...
  function Ll(e) {
    ...
    if (
      (null ===
        (n = null === (t = l.body) || void 0 === t ? void 0 : t.actions) ||
      void 0 === n
        ? void 0
        : n.length) &&
      ("string" == typeof d || d instanceof FormData)
    ) {
      var p = xl(l.body.parser);
      (i = new p({
        body: d,
        apiPayload: f,
        actions: l.body.actions,
        language: u,
        options: te,
        slugs: void 0,
        requestUrl: c,
    ...
    if (
      (null ===
        (a = null === (r = l.url) || void 0 === r ? void 0 : r.actions) ||
      void 0 === a
        ? void 0
        : a.length) &&
      "string" == typeof c
    ) {
      var h = xl(l.url.parser);
      (s = new h({
        body: c,
        requestUrl: c,
        apiPayload: f,
        actions: l.url.actions,
        language: u,
        options: te,
        slugs: void 0,
        parentParser: void 0,
    ...
    return Promise.all([
      El({ payload: f, originalUrl: c, language: u, options: te, logger: o }),
      g,
    ]).then(function (e) {
      e[0];
      var t = e[1];
      return (
        null == s || s.setSlugsReady(t),
        null == i || i.setSlugsReady(t),
        {
          url: (null == s ? void 0 : s.needsSerialization)
            ? s.serialize()
            : void 0,
          body: (null == i ? void 0 : i.needsSerialization)
            ? i.serialize()
            : void 0,
        }
      );
  ...
  function Al(e, t) {
    ...
    return (function (e, t) {
      var n = e.matchingHook,
        ...
        i = t.input,
        s = t.init;
      return Ll({ hook: n, language: r, url: a, body: o }).then(function (e) {
        if (e.url || e.body) {
    ...
    })({ matchingHook: n, language: r, url: a, body: i }, { input: s, init: l })
      .then(function (e) {
        if (!e) return c();
        var t = e.newInput,
          n = e.newInit;
      ...
      .catch(function (e) {
        return o.error(e, { sendToDatadog: !1 }), c();
      });
  }
  function Tl() {
    var e = te.network_overrides,
      t = te.is_connect;
    e &&
      (!t || te.dynamicPushState || (!Me() && Pe() !== te.language_from)) &&
      e.hooks &&
      e.hooks.length &&
      (e.xhr &&
        (function (e) {
            ...
            construct: function (t, n) {
              ...
              return (
                (r.send = function (t) {
                  ...
                  if (!u) return l();
                  var c = Pe();
                  if (te.language_from === c || Me()) return l();
                  var d =
                    null === (n = e.hooks) || void 0 === n
                      ? void 0
                      : n.find(function (e) {
                          return ul(u, e.url_match);
                        });
                  if (!d) return l();
                  Ll({ hook: d, language: c, url: u, body: t })
                    .then(function (e) {
                      e.url &&
                        ((r._wg_url = e.url),
                        a.call(
        ...
        (function (e) {
          ...
          window.fetch = function (n, r) {
            ...
            try {
              ...
              if (!s) return i();
              var l = Pe();
              if (te.language_from === l || Me()) return i();
              var u =
                null === (a = e.hooks) || void 0 === a
                  ? void 0
                  : a.find(function (e) {
                      return ul(s, e.url_match);
                    });
              if (!u) return i();
              if (
  ...
  var Cl = !1;
  function Ol(e) {
    window.postMessage({ name: f, data: e, target: _ }, window.location.origin);
  }
  function jl(e) {
    if (
      e.data &&
      ...
      if (n === f && r === v)
        if ("library" === r)
          if (((Cl = !0), a.type === g)) Ol({ type: p, payload: Pe() });
    }
  }
  J("languageChanged", function (e) {
    if (!Cl) return;
  ...
  var Nl = "weglot-ai-disclaimer",
    Rl =
      "Translated content on this website may be generated using artificial intelligence. ",
    Pl = "Learn more about AI-generated translations",
    Il = null;
  function Dl() {
  ...
  function Ml(e, t, n) {
    (e.textContent = ""), e.appendChild(document.createTextNode(t));
    var r = document.createElement("a");
    r.setAttribute("target", "_blank"),
      r.setAttribute("href", "https://www.weglot.com/ai-translation"),
      (r.textContent = n),
      e.appendChild(r);
  }
  function Wl(e, t) {
    var n = null != t ? t : _e(document, te.ai_disclaimer_selector);
    if (n) {
      var r = (function (e) {
        var t = e.querySelector("#" + Nl);
        if (t) return (t.textContent = ""), t;
        var n = document.createElement("span");
        return (n.id = Nl), e.insertBefore(n, e.firstChild), n;
      })(n);
      if ((r.setAttribute(W, ""), e !== te.language_from))
        Uo({
          words: [
            { t: 2, w: Rl },
            { t: 2, w: Pl },
          ...
          .then(function (e) {
            var t,
              n,
              a =
                null === (t = null == e ? void 0 : e.to_words) || void 0 === t
                  ? void 0
                  : t[0],
              o =
                null === (n = null == e ? void 0 : e.to_words) || void 0 === n
                  ? void 0
                  : n[1];
            null != a && null != o && Ml(r, a, o);
          })
          .catch(function () {
            Ml(r, Rl, Pl);
          });
  ...
  function zl() {
    Il && (Il.disconnect(), (Il = null));
  }
  function ql(e) {
    var t = _e(document, e);
    return !!t && (Wl(Pe(), t), zl(), !0);
  }
  function Fl(e, t) {
    if (t || !e || window.top !== window || !Ko(e)) {
      var n = [];
      try {
        ta((n = So()));
      } catch (e) {
      ...
      if (
        ...
        (r = te.xhr_hooks),
        (a = te.is_connect),
        !(r && Array.isArray(r) && r.some(fl)) ||
          (a && Me()) ||
          (ll.enable(), ll.before(dl)),
        Tl(),
        pl(e),
        window.addEventListener("message", jl),
        window.addEventListener("message", al),
        t || i)
      )
        Jo(e);
      else if (
        (te.is_connect && !i && Go("onConnectPageLoad", e),
        te.force_translation)
      ) {
        for (var s = [], l = 0, u = n; l < u.length; l += 1) {
          var d = u[l],
            f = d.closest ? d : d.parentNode;
          me(f, te.force_translation) && s.push(d);
        }
        bi(s);
      }
      !(function () {
        var e = te.ai_disclaimer_selector;
        if (e) {
          if (Me()) return Dl(), void zl();
          if (Pe() !== te.language_from && !ql(e)) {
            var t = document.body;
            t &&
        ...
        (i && !i.language_button_displayed && i.allExcluded) || (Xs(), Zs()),
        i ||
          (te.remove_unused_link_hooks &&
            (function () {
              var e = ze(),
                t = te.languages
                  .map(function (e) {
              ...
              1 === e.length && t.push(te.language_from);
              for (
                var n = t
                    .map(function (e) {
                      return qr(e);
          ...
          hi(),
          (function () {
            window.addEventListener("message", Vs, !1);
            var e = te.translate_iframes;
            if (e)
              for (var t = 0, n = ve(document.body, e); t < n.length; t += 1) {
                var r = n[t];
                r.contentWindow && Us.push(r.contentWindow);
              }
            fi({}),
              $o("onPageLanguageSet", Bs),
              "with-window-top" === ke() &&
                window.top &&
  ...
  function Ul(e, t) {
    if (
      (function () {
        if (!document.querySelector("#has-script-tags")) return !1;
        return (
          !Ms(document.head.innerHTML) &&
          !Ms(document.documentElement.innerHTML)
        );
      })()
    )
      Hl();
  ...
  function Bl() {
    if (te.api_key) {
      J(
        "initialized",
        function () {
          te.page_views_enabled &&
            (te.is_connect
              ? Kt(te.language_from, function (e) {
                  return Os(e);
                })
              : Os());
        },
      ...
      if ((Go("onWeglotSetup"), !Kl.initialized || window.Turbolinks)) {
        var t = Ws();
        Pe();
        var n = (function (e) {
          var t = Me();
          return !(
            !e ||
            e === te.language_from ||
            document.documentElement.dataset.wgTranslated === e ||
            t ||
        ...
        if (
          (n && (te.wait_transition || te.wait_transition_dynamic)
            ? (de(), te.wait_transition_dynamic && ge(500))
            : fe(),
          te.delayStart)
        )
          return J(
          ...
          case "Weglot.detect":
            e.source.postMessage(
              JSON.stringify({
                ...
                data: { initialized: Kl.initialized, options: te },
              }),
              e.origin
            );
            break;
  ...
  function $l() {
    var e, t;
    window.addEventListener("message", Vl, !1),
      null !== Ns && (clearTimeout(Ns), (Ns = null)),
      ((e = document.createElement("meta")).name = "google"),
      (e.content = "notranslate"),
      document.head && document.head.appendChild(e),
      (function () {
        if (document.documentElement) {
          var e =
              window.location.host === z ||
              -1 !== window.location.pathname.indexOf("/" + q + "/"),
            t = "cms.e.jimdo.com" === window.location.host;
          e || t || document.documentElement.setAttribute("translate", "no");
        }
      })(),
      (t = document.head.querySelector("link[href*=weglot_shopify]")) &&
  ...
  J(
    ...
    J(
      "initialized",
      function () {
        if (!te.visual_editor && !te.switcher_editor) {
          var e = te.translate_forms;
          void 0 === e && (e = []),
            e.forEach(function (e) {
              for (
                var t = e.selector,
            ...
            Pt.erase({ name: "wg-search-form", options: te });
        }
      },
      !0
    ),
    J(
      ...
      function () {
        ...
        if (
          (Js(),
          Ys(),
          (t && !t.language_button_displayed && t.allExcluded) || (Xs(), Zs()),
          e !== te.language_from)
        )
          return t
            ? (Mt().setItem("weglot_excluded", "true"),
              void Bo(te.language_from))
            : void (
                Mt().getItem("weglot_excluded") &&
                (Mt().removeItem("weglot_excluded"), Ho(e))
              );
      },
      !0
    );
  var Kl = window.Weglot || {
    initialized: !1,
    initializing: !1,
    scriptLoaded: !1,
    options: te,
    ...
    off: function (e, t) {
      for (
        var n = !1,
          r = function (t) {
            return G[t].name === e && !G[t].internal;
          },
          a =
            "function" == typeof t
              ? function (e) {
                  return r(e) && G[e].callback === t;
                }
              : function (e) {
                  return r(e);
                },
    ...
    translate: function (e, t) {
      if (!e || "object" != typeof e || Array.isArray(e)) {
        var n = "Weglot.translate: 1st argument must be an object";
        return (
          o.error(n, { sendToDatadog: !1 }), t && t(null, n), Promise.reject()
        );
      }
      var r = "words" in e && e.words,
        a = ("languageTo" in e && e.languageTo) || Pe();
      if ("string" != typeof a) {
        var i =
          "Weglot.translate: 1st argument must contain languageTo property";
        return (
          o.error(i, { sendToDatadog: !1 }), t && t(null, i), Promise.reject()
        );
      }
      if (!Array.isArray(r) || "object" != typeof r[0]) {
        var s =
          "Weglot.translate: 1st argument must contain words property as array of objects";
        return (
          o.error(s, { sendToDatadog: !1 }), t && t(null, s), Promise.reject()
        );
      }
      return a === te.language_from
        ? (t &&
            t(
              r.map(function (e) {
                return e.w;
        ...
        : new Promise(function (e, n) {
            Uo({ words: r, targetLanguage: a, opts: { title: !1, cdn: !0 } })
              .then(function (n) {
    ...
    getBestAvailableLanguage: Hr,
    getAvailableLanguages: ze,
  };
  return (
    K(ee(), "polyfillReady", function () {
      var t;
      if (!Kl.initialized && !Kl.initializing) {
        for (
          var n = 0,
          ...
          var a = r[n],
            o =
              a.src ||
              (null === (t = a.getAttribute) || void 0 === t
                ? void 0
                : t.call(a, "data-src"));
          if (o) {
            var s = i(o);
        ...
        Kl.scriptLoaded ||
          ...
          e(function () {
            var e = setTimeout(function () {
              Kl.initialized || Kl.initializing || ji(), Is(null);
            }, 5e3);
            Is(e);
          }));
      }
