...
(() => {
  ...
  var ge = (e, t, n) => (
      ...
      Ea(
        t || !e || !e.__esModule
          ? qn(n, "default", { value: e, enumerable: !0 })
          : n,
        e
      )
    ),
    $e = (e) => Ea(qn({}, "__esModule", { value: !0 }), e);
  var _a = g(() => {
    "use strict";
    (function () {
  ...
  var Zr = g(() => {
    ...
    window.tram = (function (e) {
      ...
      var d = (function (f, w, C) {
          ...
          function ie(se, oe) {
            ...
            return (
              ...
              (B.open = function (Re) {
                if (
                  ((le = {}),
                  k(Re) ? (le = Re.call(B, Ve, Ie, B, se)) : N(Re) && (le = Re),
                  N(le))
                )
        ...
        m = {
          ease: [
            ...
            function (f, w, C, N) {
              ...
              return (
                w +
                C * (-2.75 * G * k + 11 * k * k + -15.5 * G + 8 * k + 0.25 * f)
              );
            },
          ],
          "ease-in": [
          ...
          "ease-out": [
            ...
            function (f, w, C, N) {
              ...
              return (
                w +
                C * (0.3 * G * k + -1.6 * k * k + 2.2 * G + -1.8 * k + 1.9 * f)
              );
            },
          ],
          "ease-in-out": [
        ...
        q = ["-webkit-", "-moz-", "-o-", "-ms-"],
        z = function (f) {
          if (f in V.style) return { dom: f, css: f };
          var w,
            C,
            N = "",
            k = f.split("-");
          for (w = 0; w < k.length; w++)
            N += k[w].charAt(0).toUpperCase() + k[w].slice(1);
          for (w = 0; w < S.length; w++)
            if (((C = S[w] + N), C in V.style))
              return { dom: C, css: q[w] + f };
        },
        W = (t.support = {
      ...
      var ce = (t.frame = (function () {
        ...
        I = d(function (f) {
          function w(ae, pe) {
            ...
            if (!pe.weak || !this.props[he]) {
              var We = Ce[0],
                Me = this.props[he];
              return (
                Me || (Me = this.props[he] = new We.Bare()),
                Me.init(this.$el, Ee, Ce, pe),
                Me
              );
            }
          }
            ...
            if (ae) {
              ...
              if (he == "object") {
                ...
                Ve.call(
                  ...
                  Ie.call(this),
                  Ce > 0 &&
                    ((this.timer = new U({ duration: Ce, context: this })),
                    (this.active = !0),
                    pe && (this.timer.complete = G));
                var We = this,
                  Me = !1,
                  Fn = {};
                ce(function () {
          ...
          function ie(ae) {
            ...
            typeof ae == "string"
              ? ((pe = {}), (pe[ae] = 1))
              : (pe = typeof ae == "object" && ae != null ? ae : this.props),
              Ve.call(this, pe, Re),
              Ie.call(this);
          }
          function se(ae) {
          ...
          function Ie() {
            ...
            for (ae in this.props)
              (pe = this.props[ae]), pe.active && Ee.push(pe.string);
            (Ee = Ee.join(",")),
              this.style !== Ee &&
                ((this.style = Ee), (this.el.style[W.transition.dom] = Ee));
          }
              ...
              (We = ae[he]),
                he in de
                  ? (Te.transform || (Te.transform = {}),
                    (Te.transform[he] = We))
                  : (L.test(he) && (he = n(he)),
                    he in j ? (Te[he] = We) : (Me || (Me = {}), (Me[he] = We)));
            for (he in Te) {
          ...
          (f.init = function (ae) {
            ...
            W.backface &&
              H.hideBackface &&
              h(this.el, W.backface.css, "hidden");
          }),
            Ue("add", w),
            Ue("start", C),
            Ue("wait", N),
        ...
        p = d(function (f) {
          ...
          (f.init = function (G, ie, se, oe) {
            ...
            se[2] && (B = se[2]),
              ...
              (this.ease = C(ie[2], this.ease, k.ease)),
              (this.delay = u(ie[3], this.delay, k.delay)),
              (this.span = this.duration + this.delay),
              (this.active = !1),
              (this.nextStyle = null),
              (this.auto = ee.test(this.name)),
              (this.unit = oe.unit || this.unit || H.defaultUnit),
              (this.angle = oe.angle || this.angle || H.defaultAngle),
              H.fallback || oe.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    "ms" +
                    (this.ease != "ease" ? ne + m[this.ease][0] : "") +
          ...
          (f.init = function () {
            ...
            (f.values = function (N) {
              var k,
                G = {};
              return (
                C.call(this, N, function (ie, se, oe) {
                  (G[ie] = se),
        ...
        R = d(function (f) {
          ...
          var ie = { ease: m.ease[1], from: 0, to: 1 };
          (f.init = function (B) {
          ...
          (f.init = function (C) {
            ...
            (f.render = function (C) {
              ...
              for (N = G; N--; )
                (k = this.tweens[N]),
                  k.context &&
                    (k.render(C), (this.current[k.name] = k.value), (ie = !0));
              return ie
      ...
      (t.fallback = function (f) {
        ...
        (t.delay = function (f, w, C) {
          return new U({ complete: w, duration: f, context: C });
        }),
        ...
        (e.debounce = function (S, q, z) {
          var W,
            ...
            I = function () {
              ...
              y < q
                ? (W = setTimeout(I, q - y))
                : ((W = null), z || ((fe = S.apply(re, te)), (re = te = null)));
            };
          return function () {
...
` +
  ...
  var Le = g((r1, La) => {
    ...
    var kn = navigator.userAgent.toLowerCase(),
      ...
      hm = (ve.env.chrome =
        ...
        parseInt(kn.match(/chrome\/(\d+)\./)[1], 10)),
  ...
  var Fa = g((o1, Ma) => {
    ...
    ri.define(
      ...
      (Ma.exports = function (e, t, n) {
        if (
          ((n = n || {}),
          (ri.env("test") || ri.env("frame")) && !n.fixture && !Em())
        )
          return { exit: 1 };
        var r = {},
          i = e(window),
        ...
        function x(D) {
          return D.indexOf("//") >= 0
            ? D
            : T("https://editor-api.webflow.com" + D);
        }
        function T(D) {
        ...
        function e(n) {
          ...
          function u(P) {
            var D = P.type,
              F = P.tagName;
            return !!(
              (F === "INPUT" && s[D] && !P.readOnly) ||
              (F === "TEXTAREA" && !P.readOnly) ||
              P.isContentEditable
            );
          }
          function l(P) {
  ...
  var Ha = g((u1, Wa) => {
    ...
    var ii = window.jQuery,
      ...
      Xn = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), ii(t).triggerHandler(Je.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), ii(t).triggerHandler(Je.types.OUTRO));
        },
      };
    Je.triggers = {};
    Je.types = { INTRO: "w-ix-intro" + Ua, OUTRO: "w-ix-outro" + Ua };
    Je.init = function () {
  ...
  var on = g((c1, ja) => {
    ...
    Un.triggers = {};
    Un.types = { INTRO: "w-ix-intro" + za, OUTRO: "w-ix-outro" + za };
  ...
  var pi = g((sn) => {
    ...
    var gs = (sn.ActionTypes = { INIT: "@@redux/INIT" });
    function vs(e, t, n) {
      var r;
      if (
      ...
      return (
        m({ type: gs.INIT }),
        (r = { dispatch: m, subscribe: d, getState: _, replaceReducer: v }),
        (r[ps.default] = E),
        r
      );
    }
  ...
  var Es = g((vi) => {
    ...
    function fy(e) {
      Object.keys(e).forEach(function (t) {
        var n = e[t],
          r = n(void 0, { type: ms.ActionTypes.INIT });
        if (typeof r > "u")
          throw new Error(
            'Reducer "' +
              t +
      ...
      return function (r) {
        return function (i, o, s) {
          ...
          return (
            ...
            (u = my.default.apply(void 0, l)(a.dispatch)),
            hy({}, a, { dispatch: u })
          );
        };
      };
  ...
  var je,
    ...
    Ti = ye(() => {
      ...
      (je = {
        ...
        (Ly = { X_AXIS: "X_AXIS", Y_AXIS: "Y_AXIS" }),
        (Py = {
          CHILDREN: "CHILDREN",
          SIBLINGS: "SIBLINGS",
  ...
  var Wy,
    ...
    xs = ye(() => {
      "use strict";
      (Wy = "IX2_RAW_DATA_IMPORTED"),
        (Hy = "IX2_SESSION_INITIALIZED"),
        (By = "IX2_SESSION_STARTED"),
        (zy = "IX2_SESSION_STOPPED"),
        (jy = "IX2_PREVIEW_REQUESTED"),
        (Ky = "IX2_PLAYBACK_REQUESTED"),
        (Yy = "IX2_STOP_REQUESTED"),
        (Qy = "IX2_CLEAR_REQUESTED"),
        ($y = "IX2_EVENT_LISTENER_ADDED"),
        (Zy = "IX2_EVENT_STATE_CHANGED"),
        (Jy = "IX2_ANIMATION_FRAME_CHANGED"),
  ...
  var f_,
    ...
    Rs = ye(() => {
      "use strict";
      qe();
      ({ IX2_RAW_DATA_IMPORTED: f_ } = we),
        (Ss = (e = Object.freeze({}), t) => {
          switch (t.type) {
            case f_:
  ...
  var Nt = g((_e) => {
    ...
    function Gs(e, t, n, r) {
      ...
      if (r === t.length - 1) i = n;
        ...
        var s =
          Bn(e) && Bn(e[o]) ? e[o] : typeof t[r + 1] == "number" ? [] : {};
        i = Gs(s, t, n, r + 1);
      }
      return Kn(e, o, i);
    }
    ...
    function Us(e, t, n, r, i, o) {
      for (
        ...
        a[u - 6] = arguments[u];
      return a.length
        ? ke.call.apply(ke, [null, !1, !1, e, t, n, r, i, o].concat(a))
        : ke(!1, !1, e, t, n, r, i, o);
    }
    function Ws(e, t, n, r, i, o) {
      for (
        ...
        a[u - 6] = arguments[u];
      return a.length
        ? ke.call.apply(ke, [null, !1, !0, e, t, n, r, i, o].concat(a))
        : ke(!1, !0, e, t, n, r, i, o);
    }
    function Hs(e, t, n, r, i, o, s) {
      ...
      return (
        _.length
          ? (u = ke.call.apply(ke, [null, !1, !1, a, n, r, i, o, s].concat(_)))
          : (u = ke(!1, !1, a, n, r, i, o, s)),
        Yn(e, t, u)
      );
    }
    function Bs(e, t) {
    ...
    function zs(e, t, n, r, i, o) {
      for (
        ...
        a[u - 6] = arguments[u];
      return a.length
        ? ke.call.apply(ke, [null, !0, !1, e, t, n, r, i, o].concat(a))
        : ke(!0, !1, e, t, n, r, i, o);
    }
    var g_ = {
      clone: zn,
  ...
  var Ks,
    ...
    Qs = ye(() => {
      ...
      (Ks = ge(Nt())),
        ...
        (E_ = { preview: {}, playback: {}, stop: {}, clear: {} }),
        ...
        (Ys = (e = E_, t) => {
          if (t.type in js) {
            let n = [js[t.type]];
            return (0, Ks.setIn)(e, [n], { ...t.payload });
          }
          return e;
        });
    });
        ...
        (Zs = (e = $s, t) => {
          switch (t.type) {
            ...
            case S_: {
              ...
              return (0, Ne.merge)(e, { viewportWidth: n, mediaQueryKey: o });
            }
            case R_:
  ...
  var sr = g((vq, ql) => {
    var ki = xl(),
      ...
      b0 = Vt(Ui),
      It = Fl;
    ((ki && It(new ki(new ArrayBuffer(1))) != Ml) ||
      (Gi && It(new Gi()) != Ll) ||
      (Vi && It(Vi.resolve()) != Pl) ||
      (Xi && It(new Xi()) != Nl) ||
      (Ui && It(new Ui()) != Dl)) &&
  ...
  var Bl = g((mq, Hl) => {
    ...
    function R0(e, t, n, r, i, o) {
      ...
      if (m && !_)
        return (
          o || (o = new Wi()),
          s || A0(e) ? T0(e, t, n, r, i, o) : w0(e, t, u, n, r, i, o)
        );
      if (!(n & O0)) {
  ...
  var cr = g((xq, of) => {
    ...
    function ex(e, t) {
      ...
      return n == "number" ||
        ...
        $0(e)
        ? !0
        : J0.test(e) || !Z0.test(e) || (t != null && e in Object(t));
    }
    of.exports = ex;
  });
  var uf = g((Aq, sf) => {
  ...
  var id,
    ...
    vr = ye(() => {
      ...
      (id = ge(Ji())),
        ...
        (rd = ht.split("transform")[0]),
        (hr = rd ? rd + "TransformStyle" : "transformStyle");
    });
  var to = g((ek, ld) => {
    var UA = 4,
      WA = 0.001,
  ...
  var _n,
    ...
    no = ye(() => {
      ...
      (_n = ge(to())),
        (st = 1.70158),
        (YA = (0, _n.default)(0.25, 0.1, 0.25, 1)),
        (QA = (0, _n.default)(0.42, 0, 1, 1)),
        ($A = (0, _n.default)(0, 0, 0.58, 1)),
        (ZA = (0, _n.default)(0.42, 0, 0.58, 1));
    });
  var dd = {};
  Fe(dd, {
    applyEasing: () => NO,
  ...
  function NO(e, t, n) {
    return t === 0
      ...
      : t === 1
      ? 1
      : bn(n ? (t > 0 ? n(t) : t) : t > 0 && e && In[e] ? In[e](t) : t);
  }
  var fd,
    ro = ye(() => {
      "use strict";
  ...
  function gd(e, t, n, r, i) {
    let o =
      n === DO ? (0, Ut.getIn)(i, ["config", "target", "objectId"]) : null;
          ...
          switch (t.type) {
            ...
            case HO: {
              let {
                ...
                u = e;
              return (
                (0, Ut.getIn)(u, [n, r]) !== r && (u = gd(u, r, s, n, o)),
                io(u, n, a, i, o)
              );
            }
            case BO: {
            ...
            if (d != null) {
              if ((l.isPlaying || l.play(s, !1), so in a || uo in a)) {
                ...
                (v !== m.fit || E !== m.alignment) &&
                  (l.layout = m.copyWith({ fit: v, alignment: E }));
              }
              for (let m in a) {
    ...
    var OS = fo(),
      ...
      DS = (e, t, n) => {
        let {
          ...
          o = t.PLUGIN_VARIABLE,
          s = Object.values(NS).find((a) => a.match(o, i));
  ...
  var wd = g((go) => {
    ...
    var VS = new Map([
      [Er.ActionTypeConsts.PLUGIN_LOTTIE, { ...FS }],
      [Er.ActionTypeConsts.PLUGIN_SPLINE, { ...qS }],
      [Er.ActionTypeConsts.PLUGIN_RIVE, { ...kS }],
      [Er.ActionTypeConsts.PLUGIN_VARIABLE, { ...GS }],
    ]);
  });
  var xd = {};
  Fe(xd, {
  ...
  var ho,
    ...
    Io = ye(() => {
      ...
      (Tt = (e) => (t) => {
        ...
        (XS = Tt("getPluginDuration")),
        (yo = Tt("getPluginDestination")),
  ...
  var Wd = g((_k, Ud) => {
    ...
    function gR(e, t, n) {
      ...
      return (
        n !== void 0 &&
          ((i = fR(n)), (i = n < 0 ? dR(r + i, 0) : pR(i, r - 1))),
        cR(e, lR(t, 3), i, !0)
      );
    }
    Ud.exports = gR;
  ...
  function UR({ store: e, select: t, onChange: n, comparator: r = XR }) {
  ...
  function Ro({
    ...
    if (
      (Y
        ? ((K = M.limitAffectedElements), (Q = ne), (ee = a(M)))
        : (Q = ee = a({ id: b, selector: T, selectorGuids: L })),
      t && D)
    ) {
  ...
  function zR(e, t = {}, n = {}, r, i) {
    ...
    switch (r.actionTypeId) {
      ...
      case ip:
        return { value: (0, ut.default)(parseFloat(o(e, Tr)), 1) };
      case jt: {
        let a = o(e, nt),
          u = o(e, rt),
          l,
        ...
        return (
          r.config.widthUnit === vt
            ? (l = $d.test(a) ? parseFloat(a) : parseFloat(n.width))
            : (l = (0, ut.default)(parseFloat(a), parseFloat(n.width))),
          r.config.heightUnit === vt
            ? (_ = $d.test(u) ? parseFloat(u) : parseFloat(n.height))
      ...
      case Or:
        return { value: (0, ut.default)(o(e, wr), n.display) };
      case DR:
  ...
  function aC({ actionTypeId: e }, { xValue: t, yValue: n, zValue: r }) {
    return (
      (e === Ht && r !== void 0) ||
      (e === Bt && r !== void 0) ||
      (e === zt && (t !== void 0 || n !== void 0))
    );
  }
  function lC(e, t) {
    let n = e.exec(t);
  ...
  function fC({ element: e, actionTypeId: t, computedStyle: n, getStyle: r }) {
    let i = So[t],
      o = r(e, i),
      s = uC.test(o) ? o : n[i],
      a = lC(cC, s).split(xn);
  ...
  function dC(e, t, n, r, i, o) {
    ...
    switch (r.actionTypeId) {
      case jt: {
        ...
        l !== void 0 && (a === vt && (a = "px"), wt(e, nt, o), s(e, nt, l + a)),
          _ !== void 0 &&
            (u === vt && (u = "px"), wt(e, rt, o), s(e, rt, _ + u));
        break;
      }
      case On: {
        iC(e, n, r.config, o);
      ...
      case Qt: {
        let a = So[r.actionTypeId],
          ...
          d = n.aValue;
        wt(e, a, o),
          s(e, a, d >= 1 ? `rgb(${u},${l},${_})` : `rgba(${u},${l},${_},${d})`);
        break;
      }
      default: {
        let { unit: a = "" } = r.config;
  ...
  function gC({ store: e, elementApi: t }) {
    ...
    Object.keys(r).forEach((o) => {
      let s = r[o],
        ...
        { actionListId: u } = a,
        l = i[u];
      l && Zd({ actionList: l, event: s, elementApi: t });
    }),
      Object.keys(i).forEach((o) => {
        Zd({ actionList: i[o], elementApi: t });
      });
  }
  function Zd({ actionList: e = {}, event: t, elementApi: n }) {
    ...
    r &&
      ...
      i &&
        i.forEach((o) => {
          ...
          s.forEach((a) => {
            Jd({ actionGroup: a, event: t, elementApi: n });
          });
        });
  }
  function Jd({ actionGroup: e, event: t, elementApi: n }) {
    ...
    r.forEach((i) => {
      ...
      bt(o)
        ? (a = (u) => _o(o)(u, i))
        : (a = cp({ effect: vC, actionTypeId: o, elementApi: n })),
        Ro({ config: s, event: t, elementApi: n }).forEach(a);
    });
  }
  function hC(e, t, n) {
    ...
    i(e, Wt) && cp({ effect: up, actionTypeId: o, elementApi: n })(e);
  }
  function vC(e, t, n) {
    let { setStyle: r } = n;
  ...
  function yC({ actionList: e, actionItemId: t, rawData: n }) {
    let { actionItemGroups: r, continuousParameterGroups: i } = e,
      o = [],
      s = (a) => (
  ...
  function EC(e, { basedOn: t }) {
    return (
      (e === je.SCROLLING_IN_VIEW && (t === et.ELEMENT || t == null)) ||
      (e === je.MOUSE_MOVE && t === et.ELEMENT)
    );
  }
  function _C(e, t) {
    return e + NR + t;
  ...
  var ut,
    ...
    dp = ye(() => {
      ...
      ({
        ...
        (op = (e) => e.trim()),
        (So = Object.freeze({ [Kt]: tp, [Yt]: RR, [Qt]: CR })),
        (ap = Object.freeze({
          [ht]: _R,
          [tp]: ER,
          [Tr]: Tr,
      ...
      ($d = /px/),
        ...
        (BR = (e, t) =>
          t.reduce(
            (n, r) => (
              n[r.type] == null &&
                (n[r.type] = eC[r.type] || r.defaultValue || 0),
              n
            ),
            e || {}
          ));
      (jR = (e, t) => (t && (e[t.type] = t.value || 0), e)),
        ...
        (YR = (e, t, n) => {
          ...
          switch (e) {
            case On: {
              let r = (0, br.default)(n.filters, ({ type: i }) => i === t);
              return r ? r.value : 0;
            }
            case Sn: {
              let r = (0, br.default)(
      ...
      (Co = {
        ...
        (tC = (e, t) => {
          let n = (0, br.default)(t.filters, ({ type: r }) => r === e);
      ...
      (Rr = ge(xt())),
        ...
        (XC = (e, t) => {
          ...
          for (let K = 0, { length: Q } = i; K < Q; K++) {
            let { keyframe: ee, actionItems: ne } = i[K];
            if ((K === 0 && (P = ne[0]), L >= ee)) {
              P = ne[0];
              let V = i[K + 1],
                S = V && L !== ee;
              (D = S ? V.actionItems[0] : null),
                S && ((F = ee / 100), (M = (V.keyframe - ee) / 100));
            }
          }
          let Y = {};
          if (P && !D)
            ...
            let K = (T - F) / M,
              Q = P.config.easing,
              ee = gp(Q, K, l);
            for (let ne = 0, { length: V } = o; ne < V; ne++) {
              let S = o[ne],
                q = Po(u, S, P.config),
          ...
          return (0, ct.merge)(e, { position: T, current: Y });
        }),
        (UC = (e, t) => {
          let {
              active: n,
          ...
          switch (t.type) {
            ...
            case NC: {
              ...
              return (0, ct.set)(e, n, {
                ...
                skipToValue: K,
                customEasingFn:
                  Array.isArray(S) && S.length === 4 ? qC(S) : void 0,
              });
            }
            case DC: {
  ...
  var Ep,
    ...
    bp = ye(() => {
      ...
      vp();
      yp();
      ({ ixElements: zC } = _p.IX2ElementsReducer),
        (jC = (0, Ep.combineReducers)({
          ixData: Ss,
          ixRequest: Ys,
          ixSession: Zs,
          ixElements: zC,
  ...
  var Fo = g((jk, zp) => {
    ...
    function kL(e, t, n) {
      t == "__proto__" && Bp
        ? Bp(e, t, { configurable: !0, enumerable: !0, value: n, writable: !0 })
        : (e[t] = n);
    }
    zp.exports = kL;
  });
  var Kp = g((Kk, jp) => {
    ...
    function WL(e, t, n) {
      var r = e[t];
      (!(UL.call(e, t) && VL(r, n)) || (n === void 0 && !(t in e))) &&
        GL(e, t, n);
    }
    jp.exports = WL;
  });
  ...
  var hg = g((iG, gg) => {
    ...
    function XP(e) {
      ...
      for (var n in e) if (VP.call(e, n)) return !1;
      return !0;
    }
    gg.exports = XP;
  });
  ...
  var Cg = g((fG, Rg) => {
    ...
    function lN(e, t, n) {
      ...
      return (
        ...
        sN(e, t, { leading: r, maxWait: t, trailing: i })
      );
    }
    Rg.exports = lN;
  });
  ...
  var Lg,
    ...
    Nr = ye(() => {
      ...
      (Lg = ge(xt())),
        ...
        ({ reifyState: LN } = Lg.IX2VanillaUtils),
        (ko = (e) => ({ type: fN, payload: { ...LN(e) } })),
        ...
        (DN = (e) => ({ type: mN, payload: { actionListId: e } })),
        (MN = () => ({ type: yN })),
        (Cr = (e, t) => ({
          type: EN,
          payload: { target: e, listenerParams: t },
        })),
        (FN = (e = 1) => ({ type: _N, payload: { step: e } })),
        (Uo = (e, t) => ({ type: IN, payload: { stateKey: e, newState: t } })),
        (Lr = (e, t) => ({ type: bN, payload: { now: e, parameters: t } })),
        (Zt = (e, t) => ({ type: TN, payload: { key: e, value: t } })),
        (Wo = (e) => ({ type: wN, payload: { ...e } })),
        (Pr = (e, t) => ({ type: xN, payload: { instanceId: e, time: t } })),
        (Ho = (e) => ({ type: AN, payload: { instanceId: e } })),
        (Bo = (e, t, n, r) => ({
          type: ON,
  ...
  var Dg,
    ...
    Fg = ye(() => {
      ...
      Dg = ge(xt());
      qe();
      ({ ELEMENT_MATCHES: Ko } = Dg.IX2BrowserSupport),
        ({
          IX2_ID_DELIMITER: Ng,
          HTML_ELEMENT: qN,
          PLAIN_OBJECT: kN,
  ...
  var eh = g((IG, Jg) => {
    ...
    function uD(e, t, n) {
      return (
        ...
        function () {
          for (
            var r = arguments, i = -1, o = Zg(r.length - t, 0), s = Array(o);
            ++i < o;
  ...
  var ea = g((LG, bh) => {
    ...
    function LD(e) {
      for (
        var t = e.name + "", n = Ih[t], r = CD.call(Ih, t) ? n.length : 0;
        r--;
  ...
  var Oh = g((DG, Ah) => {
    ...
    function GD(e) {
      ...
      return (
        (t.__actions__ = kD(e.__actions__)),
    ...
    function aM(e) {
      return ZD(function (t) {
        ...
        for (r = s ? r : n; ++r < n; ) {
          ...
          !u[4].length &&
          u[9] == 1
            ? (s = s[ta(u[0])].apply(s, u[3]))
            : (s = o.length == 1 && Dh(o) ? s[a]() : s.thru(o));
        }
        return function () {
          var l = arguments,
            _ = l[0];
          if (s && l.length == 1 && eM(_)) return s.plant(_).value();
          for (var d = 0, m = n ? t[d].apply(this, l) : _; ++d < n; )
            m = t[d].call(this, m);
          return m;
        };
      });
  ...
  var $h,
    ...
    fv = ye(() => {
      ...
      (ev = ge(xt())),
        ...
        (ra = "COMPONENT_ACTIVE"),
        (ov = "COMPONENT_INACTIVE"),
        ({ COLON_DELIMITER: Wh } = Se),
        ({ getNamespacedParameterId: Hh } = ev.IX2VanillaUtils),
        (av = (e) => (t) => typeof t == "object" && e(t) ? !0 : t),
        (Ln = av(({ element: e, nativeEvent: t }) => e === t.target)),
        (NM = av(({ element: e, nativeEvent: t }) => e.contains(t.target))),
        (it = (0, $h.default)([Ln, NM])),
        (sv = (e, t) => {
          if (t) {
            let { ixData: n } = e.getState(),
              { events: r } = n,
        ...
        (Ge = ({ store: e, event: t, element: n, eventStateKey: r }, i) => {
          let { action: o, id: s } = t,
        ...
        (Bh = "mouseover mouseout"),
        (oa = { types: ia }),
        (MM = { PAGE_START: iv, PAGE_FINISH: rv }),
        (Cn = (() => {
        ...
        (kM = (e) => {
          let {
            ...
            { clientWidth: r, clientHeight: i } = Cn(),
        ...
        (cv = (e) => (t, n) => {
          let { type: r } = t.nativeEvent,
            i = [ra, ov].indexOf(r) !== -1 ? r === ra : n.isActive,
            o = { ...n, isActive: i };
          return ((!n || o.isActive !== n.isActive) && e(t, o)) || o;
        }),
        (zh = (e) => (t, n) => {
          let r = { elementHovered: qM(t) };
          return (
        ...
        (jh =
          (e) =>
          (t, n = {}) => {
            let { stiffScrollTop: r, scrollHeight: i, innerHeight: o } = Cn(),
              {
        ...
        (Vr = (e = !0) => ({
          ...
          handler: Ye(
            e ? it : Ln,
            cv((t, n) => (n.isActive ? Pn.handler(t, n) : n))
          ),
        })),
        (Xr = (e = !0) => ({
          ...uv,
          handler: Ye(
            e ? it : Ln,
            cv((t, n) => (n.isActive ? n : Pn.handler(t, n)))
          ),
        })),
        (Yh = {
          ...oa,
        ...
        (lv = {
          ...
          [bM]: Vr(),
          [TM]: Xr(),
          [LM]: { types: "ecommerce-cart-open", handler: Ye(it, Ge) },
          [CM]: { types: "ecommerce-cart-close", handler: Ye(it, Ge) },
          [dM]: {
            types: "click",
            handler: Ye(
              it,
              ...
              switch (s) {
                ...
                default: {
                  ...
                  let F = t.getBoundingClientRect(),
                    { left: M, top: Y, width: K, height: Q } = F;
                  if (!D && !VM({ left: d, top: m }, F)) break;
                  (P = !0), (T = b ? (d - M) / K : (m - Y) / Q);
                  break;
                }
              }
              return (
                x && (T > 1 - Qh || T < Qh) && (T = Math.round(T)),
                (s !== et.ELEMENT || P || P !== o.elementHovered) &&
                  ((T = l ? 1 - T : T), e.dispatch(Zt(L, T))),
                {
                  elementHovered: P,
                  clientX: d,
                  clientY: m,
          ...
          [PM]: {
            ...
            handler: ({ store: e, eventConfig: t }) => {
              let { continuousParameterGroupId: n, reverse: r } = t,
                { scrollTop: i, scrollHeight: o, clientHeight: s } = Cn(),
                a = i / (o - s);
          ...
          [RM]: {
            ...
            handler: (
              ...
              if (_ === et.VIEWPORT) {
                let D = P ? o / a : s / u;
                return (
                  D !== i.scrollPercent && t.dispatch(Zt(m, D)),
                  { scrollPercent: D }
                );
              } else {
                let D = Hh(r, m),
                ...
                return (
                  S !== i.scrollPercent && t.dispatch(Zt(D, S)),
                  { scrollPercent: S }
                );
              }
            },
  ...
  function uF(e) {
    At({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: fF }),
      At({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: dF }),
      At({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: pF }),
  ...
  function fF({ rawData: e, defer: t }, n) {
    let r = () => {
      jr({ store: n, rawData: e, allowEvents: !0 }), bv();
    };
    t ? setTimeout(r, 0) : r();
  }
  function bv() {
  ...
  function dF(e, t) {
    ...
    if (r && i && _ && a) {
      ...
      d && (_ = $M({ actionList: d, actionItemId: i, rawData: _ }));
    }
    if (
      (jr({ store: t, rawData: _, allowEvents: s, testManual: u }),
      (r && n === Pe.GENERAL_START_ACTION) || sa(n))
    ) {
      en({ store: t, actionListId: r }),
        wv({ store: t, actionListId: r, eventId: o });
      let d = Nn({
        store: t,
        eventId: o,
        actionListId: r,
      ...
      l && d && t.dispatch(Jt({ actionListId: r, isPlaying: !a }));
    }
  }
  function pF({ actionListId: e }, t) {
    e ? en({ store: t, actionListId: e }) : xv({ store: t }), Kr(t);
  }
  function gF(e, t) {
    Kr(t), Iv({ store: t, elementApi: De });
  }
  function jr({ store: e, rawData: t, allowEvents: n, testManual: r }) {
    ...
    t && e.dispatch(ko(t)),
      i.active ||
        ...
        n &&
          (_F(e), hF(), e.getState().ixSession.hasDefinedMediaQueries && cF(e)),
        e.dispatch(Vo()),
        vF(e, r));
  }
  function hF() {
  ...
  function vF(e, t) {
    let n = (r) => {
      ...
      i.active &&
        (e.dispatch(Lr(r, o)), t ? lF(e, n) : requestAnimationFrame(n));
    };
      ...
      x.forEach(({ element: D, key: F }) => {
        let M = b[F],
          ...
          ee = (
            ...
            ? la(K)(D, Y)
            : null,
          ne = ca({ element: D, actionItem: Y, elementApi: De }, ee);
        fa({
          store: e,
          element: D,
          eventId: r,
  ...
  function Tv(e) {
    ...
    if (r !== t.viewportWidth) {
      ...
      e.dispatch(zo({ width: r, mediaQueries: i }));
    }
  }
  function AF({ logic: e, store: t, events: n }) {
    OF(n);
    ...
    (0, tn.default)(a, (d, m) => {
      ...
      rF(x, o.mediaQueryKeys) || t.dispatch(jo()),
        E.actionTypeId === Pe.GENERAL_CONTINUOUS_ACTION &&
          (Array.isArray(v.config) ? v.config : [v.config]).forEach((P) => {
            let { continuousParameterGroupId: D } = P,
              F = (0, lt.default)(s, `${T}.continuousParameterGroups`, []),
              M = (0, gv.default)(F, ({ id: Q }) => Q === D),
              Y = (P.smoothing || 0) / 100,
              K = (P.restingState || 0) / 100;
            M &&
              d.forEach((Q, ee) => {
                let ne = b + ua + ee;
                yF({
        ...
        (E.actionTypeId === Pe.GENERAL_START_ACTION || sa(E.actionTypeId)) &&
          wv({ store: t, actionListId: T, eventId: b });
    });
    let u = (d) => {
        ...
        wF(a, (v, E, b) => {
          let x = n[E],
            T = m.eventState[b],
            { action: L, mediaQueries: P = o.mediaQueryKeys } = x;
          ...
          L.actionTypeId === Pe.GENERAL_CONTINUOUS_ACTION
            ? (Array.isArray(x.config) ? x.config : [x.config]).forEach(D)
            : D();
        });
      },
      l = (0, Ev.default)(u, sF),
      _ = ({ target: d = document, types: m, throttle: v }) => {
        m.split(" ")
          .filter(Boolean)
          .forEach((E) => {
            let b = v ? l : u;
  ...
  function wv({ store: e, actionListId: t, eventId: n }) {
    ...
    if (u && u.useFirstGroupAsInitialState) {
      ...
      l.forEach((d) => {
        let { config: m, actionTypeId: v } = d,
          E =
            m?.target?.useEventTarget === !0 && m?.target?.objectId == null
              ? { target: a.target, targets: a.targets }
              : m,
          b = Hr({ config: E, event: a, elementApi: De }),
          x = zr(v);
        b.forEach((T) => {
          let L = x ? la(v)(T, d) : null;
          fa({
            destination: ca({ element: T, actionItem: d, elementApi: De }, L),
            immediate: !0,
            store: e,
            element: T,
            eventId: n,
  ...
  function xv({ store: e }) {
    ...
    (0, tn.default)(t, (n) => {
      if (!n.continuous) {
        ...
        da(n, e), i && e.dispatch(Jt({ actionListId: r, isPlaying: !1 }));
      }
    });
  }
  function en({
    ...
    let { ixInstances: o, ixSession: s } = e.getState(),
      a = s.hasBoundaryNodes && n ? Rn(n, Wr) : null;
    (0, tn.default)(o, (u) => {
  ...
  function Nn({
    ...
    let { ixData: u, ixSession: l } = e.getState(),
      { events: _ } = u,
      d = _[t] || {},
      { mediaQueries: m = u.mediaQueryKeys } = d,
      v = (0, lt.default)(u, `actionLists.${i}`, {}),
      { actionItemGroups: E, useFirstGroupAsInitialState: b } = v;
    if (!E || !E.length) return !1;
    o >= E.length && (0, lt.default)(d, "config.loop") && (o = 0),
      o === 0 && b && o++;
    let T =
        (o === 0 || (o === 1 && b)) && sa(d.action?.actionTypeId)
          ? d.config.delay
          : void 0,
    ...
    return (
      L.forEach((M, Y) => {
        ...
        Hr({
          ...
          F = !0;
          let re = D === Y && z === 0,
            ce = YM({ element: q, actionItem: M }),
            fe = ca({ element: q, actionItem: M, elementApi: De }, W);
          fa({
            store: e,
            element: q,
            actionItem: M,
  ...
  function fa(e) {
    let { store: t, computedStyle: n, ...r } = e,
      ...
      { refState: T } = v[x] || {},
      L = $o(i),
      P = E.reducedMotion && wi[o.actionTypeId],
      D;
    if (P && u)
    ...
    if (
      ...
      Av(document.body, "ix2-animation-started", m),
      s)
    ) {
      SF(t, m);
      return;
    }
    At({ store: t, select: ({ ixInstances: M }) => M[m], onChange: Ov }),
  ...
  function Ov(e, t) {
    let {
      ...
      { ixData: P, ixSession: D } = t.getState(),
      { events: F } = P,
      M = F && F[d] ? F[d] : {},
    ...
    if (Br(Y, D.mediaQueryKey) && (r || n || i)) {
      if (l || (u === HM && i)) {
        ...
        let { ixElements: K } = t.getState(),
          { ref: Q, refType: ee, refState: ne } = K[o] || {},
          V = ne && ne[a];
      ...
      if (i) {
        if (b) {
          ...
          T && !K && t.dispatch(Jt({ actionListId: E, isPlaying: !1 }));
        }
        da(e, t);
      }
    }
  ...
  var gv,
    ...
    aa = ye(() => {
      ...
      (WM = Object.keys(Wn)),
        ...
        (pv = navigator.userAgent),
        (aF = pv.match(/iPad/i) || pv.match(/iPhone/)),
        (sF = 12);
      IF = ["resize", "orientationchange"];
      (TF = (e, t) => (0, vv.default)((0, yv.default)(e, t), mv.default)),
        (wF = (e, t) => {
          (0, tn.default)(e, (n, r) => {
            n.forEach((i, o) => {
              let s = r + ua + o;
        ...
        (xF = (e) => {
          ...
          return Hr({ config: t, elementApi: De });
        });
    });
  var Lv = g((ga) => {
    "use strict";
    ...
    function FF(e) {
      Cv(), (0, pa.startEngine)({ store: Yr, rawData: e, allowEvents: !0 });
    }
    function Cv() {
      (0, pa.stopEngine)(Yr);
    }
          ...
          if (!T.getAttribute("hreflang")) {
            ...
            if (((a.href = L), !(L.indexOf(":") >= 0))) {
              ...
              if (
                ...
                var D = e(a.hash);
                D.length && d.push({ link: P, sec: D, active: !1 });
                return;
              }
              if (!(L === "#" || L === "")) {
                var F =
                  a.href === s.href || L === m || (l.test(L) && _.test(m));
                x(P, u, F);
              }
            }
          }
      ...
      (kv.exports = function (e) {
        ...
        function P(V, S) {
          ...
          switch (S) {
            case "add":
              (q = V.attr("tabindex")),
                q
                  ? V.attr("data-wf-tabindex-swap", q)
                  : V.attr("tabindex", "-1");
              break;
            case "remove":
              (q = V.attr("data-wf-tabindex-swap")),
                q
                  ? (V.attr("tabindex", q),
        ...
        function F(V) {
          if (
            ...
            r &&
            r.pushState &&
            !(Qr.env.chrome && n.protocol === "file:")
          ) {
            var S = r.state && r.state.hash;
            S !== V && r.pushState({ hash: V }, "", V);
          }
        }
        function M(V, S) {
          var q = i.scrollTop(),
          ...
          if (q !== z) {
            var W = K(V, q, z),
              ...
              re = function () {
                var ce = Date.now() - te;
                window.scroll(0, Q(q, z, ce, W)),
                  ce <= W ? a(re) : typeof S == "function" && S();
              };
            a(re);
          }
        }
        ...
        function ne() {
          var { WF_CLICK_EMPTY: V, WF_CLICK_SCROLL: S } = t;
          o.on(S, d, D),
            o.on(V, _, function (q) {
              q.preventDefault();
            }),
      ...
      (Vv.exports = function (e) {
        ...
        function r(o) {
          ...
          function d(x) {
            ...
            (T && T.length > 1) ||
              ((s = !0),
              T ? ((a = !0), (l = T[0].clientX)) : (l = x.clientX),
              (_ = l));
          }
          function m(x) {
            if (s) {
              ...
              (_ = L),
                Math.abs(P) > u &&
                  n &&
                  String(n()) === "" &&
                  (i("swipe", x, { direction: P > 0 ? "right" : "left" }), E());
            }
          }
          function v(x) {
      ...
      (Wv.exports = function (e, t) {
        ...
        function Y(c, A) {
          ...
          R ||
            ...
            (R.complete = W(R)),
            (R.mouseLeave = re(R)),
            (R.mouseUpOutside = z(R)),
            (R.mouseMoveOutside = ce(R)),
            K(R);
          var U = R.toggle.attr("id"),
            J = R.list.attr("id");
          U || (U = "w-dropdown-toggle-" + c),
            J || (J = "w-dropdown-list-" + c),
            R.toggle.attr("id", U),
            R.toggle.attr("aria-controls", J),
            ...
            R.list.attr("id", J),
            R.list.attr("aria-labelledby", U),
            R.links.each(function (h, X) {
              X.hasAttribute("tabindex") || X.setAttribute("tabindex", "0"),
                GF.test(X.hash) && X.addEventListener("click", V.bind(null, R));
            }),
            R.el.off(u),
            R.toggle.off(u),
            R.nav && R.nav.off(u);
          ...
          s && R.el.on(P, Q(R)),
            s ||
              (i && ((R.hovering = !1), V(R)),
              R.config.hover && R.toggle.on(E, te(R)),
              R.el.on(L, H),
              R.el.on(v, fe(R)),
              R.el.on(m, p(R)),
              R.toggle.on(T, H),
        ...
        function Q(c) {
          return function (A, O) {
            (O = O || {}),
              K(c),
              O.open === !0 && ne(c),
              O.open === !1 && V(c, { immediate: !0 });
          };
        }
        function ee(c, A) {
          return n(function (O) {
            if (c.open || (O && O.type === "w-close"))
              return V(c, { forceClose: A });
            ne(c);
          });
        }
        function ne(c) {
          if (!c.open) {
            ...
            var A = Ot.env("editor");
            s || D.on(T, c.mouseUpOutside),
              c.hovering && !A && c.el.on(x, c.mouseLeave),
              c.hovering && A && D.on(b, c.mouseMoveOutside),
              window.clearTimeout(c.delayId);
          }
        }
        function V(c, { immediate: A, forceClose: O } = {}) {
          if (c.open && !(c.config.hover && c.hovering && !O)) {
            c.toggle.attr("aria-expanded", "false"), (c.open = !1);
            var R = c.config;
            if (
              (_.outro(0, c.el[0]),
              D.off(T, c.mouseUpOutside),
              D.off(b, c.mouseMoveOutside),
              c.el.off(x, c.mouseLeave),
              window.clearTimeout(c.delayId),
              !R.delay || A)
            )
              return c.complete();
        ...
        function z(c) {
          return (
            c.mouseUpOutside && D.off(T, c.mouseUpOutside),
            n(function (A) {
              if (c.open) {
                var O = e(A.target);
          ...
          return function (A) {
            if (!(s || !c.open))
              switch (
                ...
                case Qe.HOME:
                  return c.open
                    ? ((c.selectedIdx = 0), I(c), A.preventDefault())
                    : void 0;
                case Qe.END:
                  return c.open
        ...
        function p(c) {
          return n(function (A) {
            var { relatedTarget: O, target: R } = A,
              U = c.el[0],
              J = U.contains(O) || U.contains(R);
      ...
      (zv.exports = function (e, t) {
        ...
        function F() {
          (l = e("html").attr("data-wf-site")),
            (b = "https://webflow.com/api/v1/form/" + l),
            a &&
        ...
        function Y(p, c) {
          var A = e(c),
            O = e.data(c, u);
          O || (O = e.data(c, u, { form: A })), Q(O);
          var R = A.closest("div.w-form");
          (O.done = R.find("> .w-form-done")),
            (O.fail = R.find("> .w-form-fail")),
            (O.fileUploads = R.find(".w-file-upload")),
            O.fileUploads.each(function (H) {
              fe(H, O);
            }),
            T &&
              ((O.wait = !1),
        ...
        function K() {
          ...
          i.on(
            ...
            i.on("change", u + ' form input[type="radio"]', (H) => {
              e(`input[name="${H.target.name}"]:not(${p})`).map((X, Z) =>
                e(Z).siblings(c).removeClass(A)
              );
              let h = e(H.target);
            ...
            J.forEach(([H, h]) => {
              i.on(
                "focus",
                u + ` form input[type="${H}"]:not(` + h + ")",
                (X) => {
                  e(X.target).siblings(h).addClass(O),
                    e(X.target).filter(U).siblings(h).addClass(R);
                }
              ),
                i.on(
                  "blur",
        ...
        function Q(p) {
          ...
          (p.wait = p.btn.attr("data-wait") || null),
            (p.success = !1),
            c.prop("disabled", !!(T && !p.turnstileToken)),
            p.label && c.val(p.label);
        }
        function ee(p) {
          var c = p.btn,
            A = p.wait;
            ...
            p
              ...
              .each(function (O, R) {
                var U = e(R),
                  J = U.attr("type"),
                  H =
                    U.attr("data-name") || U.attr("name") || "Field " + (O + 1);
        ...
        function V(p) {
          var c = {};
          return (
            p.find(':input[type="file"]').each(function (A, O) {
              var R = e(O),
          ...
          return (
            c === "password"
              ...
              ? O
                ? _.test(p.attr("type")) &&
                  (d.test(O) ||
                    (R = "Please enter a valid email address for: " + A))
                : (R = "Please fill out the required field: " + A)
        ...
        function te(p) {
          ...
          t.each(A, function (h, X) {
            _.test(X) && (A.EMAIL = h),
              /^((full[ _-]?)?name)$/i.test(X) && (R = h),
              /^(first[ _-]?name)$/i.test(X) && (A.FNAME = h),
              /^(last[ _-]?name)$/i.test(X) && (A.LNAME = h);
          }),
            R &&
              !A.FNAME &&
              ((R = R.split(" ")),
          ...
          if (
            ...
            be.on("click keydown", function (oe) {
              ...
              h.on("change", function (oe) {
                (A = oe.target && oe.target.files && oe.target.files[0]),
                  A &&
                    (R.toggle(!1),
                    H.toggle(!1),
                    U.toggle(!0),
        ...
        function I(p, c) {
          var A = new URLSearchParams({ name: p.name, size: p.size });
          e.ajax({ type: "GET", url: `${x}?${A}`, crossDomain: !0 })
            .done(function (O) {
              c(null, O);
            })
            .fail(function (O) {
    ...
    function zF(e, t, n, r) {
            ...
            l.forEach(function (c, A) {
              var O = fe("thumbnail"),
                R = fe("item")
                  ...
                  .attr("role", "tab")
                  .append(O);
              Dn(R, `show item ${A + 1} of ${l.length}`),
                Mn(c) && R.addClass(Kv),
                (d.items = d.items.add(R)),
                ee(c.thumbnailUrl || c.url, function (U) {
                  U.prop("width") > U.prop("height")
                    ? W(U, "wide")
                    : W(U, "tall"),
                    O.append(W(U, "thumbnail-image"));
                });
            }),
      ...
      (E.build = function () {
        return (
          ...
          (d.arrowLeft = fe("control left inactive")
            .attr("role", "button")
            .attr("aria-hidden", !0)
            .attr("aria-controls", "w-lightbox-view")),
          (d.arrowRight = fe("control right inactive")
            .attr("role", "button")
            .attr("aria-hidden", !0)
            .attr("aria-controls", "w-lightbox-view")),
          (d.close = fe("control close").attr("role", "button")),
          Dn(d.arrowLeft, "previous image"),
          Dn(d.arrowRight, "next image"),
          Dn(d.close, "close lightbox"),
          (d.spinner = fe("spinner")
          ...
          (d.strip = fe("strip").attr("role", "tablist")),
          (m = new S(d.spinner, q("hide"))),
          (d.content = fe("content").append(
            d.spinner,
            d.arrowLeft,
            d.arrowRight,
            d.close
          )),
          (d.container = fe("container").append(d.content, d.strip)),
          (d.lightbox = fe("backdrop hide").append(d.container)),
          d.strip.on("click", z("item"), P),
          d.content
            .on("swipe", D)
            .on("click", z("left"), x)
            .on("click", z("right"), T)
            .on("click", z("close"), L)
            .on("click", z("image, caption"), T),
          d.container.on("click", z("view"), L).on("dragstart", z("img"), M),
          d.lightbox.on("keydown", Y).on("focusin", F),
            ...
            return (
              ee(R, function (U) {
                ...
                p.html &&
                  ...
                  J.append(W(X, "embed"))),
                  p.caption &&
                    J.append(fe("caption", "figcaption").text(p.caption)),
                  d.spinner.before(h),
                  Z || j();
                function j() {
                  if (
                  ...
                  let de = HF(y, l);
                  re(d.arrowLeft, "inactive", de),
                    ce(d.arrowLeft, de),
                    de && d.arrowLeft.is(":focus") && d.arrowRight.focus();
                  let be = BF(y, l);
                  if (
                    (re(d.arrowRight, "inactive", be),
                    ce(d.arrowRight, be),
        ...
        (E.hide = function () {
          return (
            i(d.lightbox).add("opacity .3s").start({ opacity: 0 }).then(Q), E
          );
        }),
        (E.prev = function () {
          var y = ma(_ - 1, l);
      ...
      function Q() {
        d &&
          ...
          v.forEach(function (y) {
            ...
            p &&
              (y.hidden
                ? p.attr("aria-hidden", y.hidden)
                : p.removeAttr("aria-hidden"),
              y.tabIndex
                ? p.attr("tabIndex", y.tabIndex)
      ...
      function V(y) {
        ...
        A < R
          ? (H = Math.max(0, A + O - U))
          : A + O > U + R && (H = Math.min(A, J)),
          H != null &&
            i(d.strip).add("scroll-left 500ms").start({ "scroll-left": H });
      }
      function S(y, p, c) {
        (this.$element = y),
          (this.className = p),
          ...
          webflowLightBox: function () {
            ...
            e.each(v, function (E, b) {
              ...
              x ||
                ...
                _(x),
                s
                  ? x.el.on("setting" + a, _.bind(null, x))
                  : x.el.on("click" + a, d(x)).on("click" + a, function (T) {
                      T.preventDefault();
                    });
            });
          },
      ...
      ($v.exports = function (e, t) {
        ...
        function Q(h, X) {
          ...
          de &&
            ...
            S(j),
            l
              ? (ne(j), j.el.on("setting" + v, q(j)))
              : (V(j),
                j.button.on("click" + v, ce(j)),
                j.menu.on("click" + v, "a", fe(j)),
                j.button.on("keydown" + v, z(j)),
                j.el.on("keydown" + v, W(j))),
            p(h, X);
        }
        function ee(h, X) {
          var Z = e.data(X, v);
        ...
        function S(h) {
          ...
          (X.animOver = /^over/.test(j)),
            (X.animDirect = /left$/.test(j) ? -1 : 1),
            Z.animation !== j && h.open && t.defer(re, h),
        ...
        function U(h, X) {
          ...
          var N = f + be;
          r(h.menu).add(C).set({ y: -N }).start({ y: 0 }).then(k);
          function k() {
        ...
        function H(h, X) {
          ...
          var f = xe + de;
          r(h.menu).add(j).start({ y: -f }).then(w);
          function w() {
            h.menu.height(""),
      ...
      (em.exports = function (e, t) {
        ...
        function P(I, y) {
          ...
          c ||
            ...
            (c.mask = p.children(".w-slider-mask")),
            (c.left = p.children(".w-slider-arrow-left")),
            (c.right = p.children(".w-slider-arrow-right")),
            (c.nav = p.children(".w-slider-nav")),
          ...
          c.el.off(u),
            ...
            D(c),
            s
              ? (c.el.on("setting" + u, S(c)), V(c), (c.hasTimer = !1))
              : (c.el.on("swipe" + u, S(c)),
                c.left.on("click" + u, K(c)),
                c.right.on("click" + u, Q(c)),
                c.left.on("keydown" + u, Y(c, K)),
                c.right.on("keydown" + u, Y(c, Q)),
                c.nav.on("keydown" + u, "> div", S(c)),
                c.config.autoplay &&
                  !c.hasTimer &&
                  ((c.hasTimer = !0), (c.timerCount = 1), ne(c)),
        ...
        function D(I) {
          ...
          if (
            ((y.duration = p != null ? parseInt(p, 10) : 500),
            F(I.el.attr("data-infinite")) && (y.infinite = !0),
            F(I.el.attr("data-disable-swipe")) && (y.disableSwipe = !0),
            F(I.el.attr("data-hide-arrows"))
              ? (y.hideArrows = !0)
              : I.config.hideArrows && (I.left.show(), I.right.show()),
            F(I.el.attr("data-autoplay")))
          ) {
            (y.autoplay = !0),
        ...
        function M(I, y, p) {
          return function (c) {
            if (y) I.hasFocus[p] = y;
              ...
              e.contains(I.el.get(0), c.relatedTarget) ||
              ((I.hasFocus[p] = y),
              (I.hasFocus.mouse && p === "keyboard") ||
                (I.hasFocus.keyboard && p === "mouse"))
            )
              return;
            y
              ? (I.ariaLiveLabel.attr("aria-live", "polite"),
                I.hasTimer && V(I))
              : (I.ariaLiveLabel.attr("aria-live", "off"), I.hasTimer && ne(I));
          };
        }
        function Y(I, y) {
          return function (p) {
        ...
        function ee(I, y) {
          var p = null;
          y === I.slides.length && (b(), te(I)),
            t.each(I.anchors, function (c, A) {
              e(c.els).each(function (O, R) {
                e(R).index() === y && (p = A);
              });
            }),
            p != null && z(I, { index: p, immediate: !0 });
        }
        function ne(I) {
          V(I);
          var y = I.config,
        ...
        function S(I) {
          return function (y, p) {
            ...
            if (I.nav.has(y.target).length) {
              ...
              if (
                (y.type === "click" && z(I, { index: A }), y.type === "keydown")
              )
                switch (y.keyCode) {
                  case ot.ENTER:
                  case ot.SPACE: {
                    z(I, { index: A }), y.preventDefault();
                    break;
                  }
                  case ot.ARROW_LEFT:
                  case ot.ARROW_UP: {
        ...
        function z(I, y) {
          ...
          A < 0
            ? ((A = c.length - 1),
              p.infinite &&
                ((O.x = -I.endX), (O.from = 0), (O.to = c[0].width)))
            : A >= c.length &&
              ((A = 0),
              p.infinite &&
                ((O.x = c[c.length - 1].width),
                (O.from = -c[c.length - 1].x),
                (O.to = O.from - O.x))),
            (I.index = A);
          var R = I.nav
            .children()
          ...
          I.nav
            ...
            .attr("tabindex", "-1"),
            p.hideArrows &&
              (I.index === c.length - 1 ? I.right.hide() : I.right.show(),
              I.index === 0 ? I.left.hide() : I.left.show());
          var U = I.offsetX || 0,
            J = (I.offsetX = -c[I.index].x),
            H = { x: J, opacity: 1, visibility: "" },
            h = e(c[I.index].els),
          ...
          if (
            (s || I.ariaLiveLabel.text(`Slide ${A + 1} of ${c.length}.`),
            j === "cross")
          ) {
            var C = Math.round(be - be * p.crossOver),
              N = Math.round(be - C);
            (f = "opacity " + C + "ms " + de),
              r(X).set({ visibility: "" }).add(f).start({ opacity: 0 }),
              r(h)
                .set({ visibility: "", x: J, opacity: 0, zIndex: I.depth++ })
                .add(f)
                .wait(N)
                .then({ opacity: 1 })
                .then(k);
          ...
          p.infinite && O.x
            ? (r(I.slides.not(X))
                .set({ visibility: "", x: O.x })
                .add(w)
                .start({ x: J }),
              r(X).set({ visibility: "", x: O.from }).add(w).start({ x: O.to }),
              (I.shifted = X))
            : (p.infinite &&
                I.shifted &&
                (r(I.shifted).set({ visibility: "", x: U }),
                (I.shifted = null)),
              r(I.slides).set({ visibility: "" }).add(w).start({ x: J }));
          function k() {
            (h = e(c[I.index].els)),
              (Z = I.slides.not(h)),
              j !== "slide" && (H.visibility = "hidden"),
              r(Z).set(H);
          }
        }
        function W(I, y) {
        ...
        function te(I) {
          ...
          R < 0 && (R = 0),
            ...
            I.slides.each(function (J, H) {
              c - p > R &&
                (y++,
                (p += O),
                (I.anchors[y - 1] = { els: [], x: c, width: 0 })),
                (A = e(H).outerWidth(!0)),
                (c += A),
                (I.anchors[y - 1].width += A),
                I.anchors[y - 1].els.push(H);
          ...
          var U = I.index;
          U >= y && (U = y - 1), z(I, { immediate: !0, index: U });
        }
        function re(I) {
          var y = [],
            p,
            c = I.el.attr("data-nav-spacing");
          c && (c = parseFloat(c) + "px");
          for (var A = 0, O = I.pages; A < O; A++)
            (p = e(l)),
              p
                ...
                .attr("role", "button")
                .attr("tabindex", "-1"),
              I.nav.hasClass("w-num") && p.text(A + 1),
              c != null && p.css({ "margin-left": c, "margin-right": c }),
              y.push(p);
  ...
  events: {
    ...
    "e-14": {
      ...
      target: {
        ...
        originalId:
          "656ef8b027ad4189724cf533|bec01694-10cb-99e6-1449-9179b9e8aa52",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-38": {
      ...
      target: {
        ...
        originalId:
          "656ef8b027ad4189724cf4e3|25c10dcb-638f-d2e7-98f5-dfa3cd907bc1",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-166": {
      ...
      action: {
        id: "",
        actionTypeId: "GENERAL_CONTINUOUS_ACTION",
        config: { actionListId: "a-67", affectedElements: {}, duration: 0 },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "656ef8b027ad4189724cf4de",
    ...
    "e-202": {
      ...
      target: {
        selector: ".control",
        originalId:
          "656ef8b027ad4189724cf4de|51a850fa-a40e-8bfc-4faa-a95dec2262a4",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-259": {
      ...
      action: {
        id: "",
        actionTypeId: "GENERAL_CONTINUOUS_ACTION",
        config: { actionListId: "a-91", affectedElements: {}, duration: 0 },
      },
      mediaQueries: ["main"],
      target: {
    ...
    "e-281": {
      ...
      target: {
        ...
        originalId:
          "656ef8b027ad4189724cf4de|77bada86-e977-99a3-a19e-52b04ae13cf4",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-290": {
      ...
      target: {
        selector: ".close-link",
        originalId:
          "656ef8b027ad4189724cf4ea|424af766-ab3b-9821-983b-91a2a4f70fcf",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-299": {
      ...
      target: {
        selector: ".button",
        originalId:
          "61f29c0959b6d0c1ae94631f|8bd18f06-e04f-3434-a859-ce36219f63bd",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-404": {
      ...
      target: {
        ...
        originalId:
          "656ef8b027ad4189724cf4f1|cc84a292-e56d-d2fe-db7b-33bf6e496ec8",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-416": {
      ...
      action: {
        id: "",
        actionTypeId: "GENERAL_CONTINUOUS_ACTION",
        config: { actionListId: "a-145", affectedElements: {}, duration: 0 },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
    ...
    "e-419": {
      ...
      target: {
        ...
        originalId:
          "656ef8b027ad4189724cf4de|e4fca4d6-9e98-af54-b432-e68fc2695108",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-427": {
      ...
      action: {
        id: "",
        actionTypeId: "GENERAL_CONTINUOUS_ACTION",
        config: { actionListId: "a-151", affectedElements: {}, duration: 0 },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "656ef8b027ad4189724cf4db",
    ...
    "e-443": {
      ...
      action: {
        id: "",
        actionTypeId: "GENERAL_CONTINUOUS_ACTION",
        config: { actionListId: "a-153", affectedElements: {}, duration: 0 },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
    ...
    "e-545": {
      ...
      action: {
        id: "",
        actionTypeId: "GENERAL_CONTINUOUS_ACTION",
        config: { actionListId: "a-188", affectedElements: {}, duration: 0 },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
    ...
    "e-552": {
      ...
      action: {
        id: "",
        actionTypeId: "GENERAL_CONTINUOUS_ACTION",
        config: { actionListId: "a-195", affectedElements: {}, duration: 0 },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "2def6f11-1de0-09fc-295e-437d8e95a902",
                        "654bc14e-5add-2a54-e38c-e78fe023f627",
                      ],
                    },
                    yValue: 0,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "d395af15-74af-c994-f8b5-c1a322ee1a4b",
                        "66021f0c-25b2-04f2-2674-6f32b57683f9",
                      ],
                    },
                    yValue: 0,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "845a5628-2791-021c-a3e4-02196dc35415",
                        "b706c312-d103-b938-9569-386bd9b0c490",
                      ],
                    },
                    yValue: 80,
                    xUnit: "PX",
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "d395af15-74af-c994-f8b5-c1a322ee1a4b",
                        "b461c1e8-a692-8e55-aecd-33b5406c9a26",
                      ],
                    },
                    yValue: 360,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "5f65311b-f2fd-a2d8-728c-7e77d6da53ce",
                        "a3948a7e-5c9f-c177-24fd-580ce49f9bd9",
                      ],
                    },
                    yValue: -640,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "f4b4401f-f320-93c8-0dba-b719a8ffba0f",
                      ],
                    },
                    yValue: 240,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "d0fa3715-b44e-256d-0d54-80ab61918369",
                      ],
                    },
                    yValue: 960,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "f44f86ec-61cb-8beb-9c40-6c5ebe28510f",
                        "8170541d-f8bb-c525-85f0-7884ddbee423",
                      ],
                    },
                    yValue: -400,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "756eceb5-c913-8c86-6557-ffa58d51560c",
                        "8ebcaea0-47b3-d96d-ae5a-0286e6a5c908",
                      ],
                    },
                    yValue: -800,
                    xUnit: "PX",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "6436b1e1-6c9f-c5f8-718c-e78d54d471e8",
                        "441b3993-5402-a395-ee6f-1c807569700b",
                      ],
                    },
                    yValue: 800,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "c6bdfc84-2e2f-4a79-e3f9-2bfcb6eb586d",
                        "c553f421-07ec-3cca-1455-8a2ea9bf9803",
                      ],
                    },
                    yValue: -560,
                    xUnit: "PX",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1a76f5fe-4bee-1ef0-d341-e974f567d0e4",
                        "bcb2f44b-b34c-f3c5-24a8-ff74785ca313",
                        "9cacd727-ec57-00dc-cd7c-bf0cad6b06b3",
                      ],
                    },
                    yValue: 800,
                    xUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                filters: [
                  { type: "grayscale", filterId: "d25d", value: 0, unit: "%" },
                ],
              },
            },
          ],
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "a3505c9b-fc70-daf8-2c4a-9d72fc7b5f20",
                        "c5194e3c-982d-083f-1dab-3ed122434c02",
                      ],
                    },
                    yValue: 0,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "a3505c9b-fc70-daf8-2c4a-9d72fc7b5f20",
                        "b00f3433-799e-015b-5117-529d86cf42c4",
                      ],
                    },
                    yValue: 0,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "a3505c9b-fc70-daf8-2c4a-9d72fc7b5f20",
                        "ba7bc67d-af7e-dc38-4eb1-1848abd9cc72",
                      ],
                    },
                    yValue: 0,
                    xUnit: "PX",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    easing: "",
                    duration: 500,
                    target: { id: "53935799-fc91-c813-6775-898bb32c328e" },
                    yValue: 160,
                    xUnit: "PX",
                    yUnit: "PX",
                    zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "ded8d7f5-f7d9-7f3d-1146-de5144f2cadf",
                    "0b13fdef-e76d-0b01-9beb-07b12c9fd9eb",
                  ],
                },
                yValue: -1,
                xUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "041ae113-a1ab-7d75-9348-1f3ecf4b6f57" },
                yValue: 100,
                xUnit: "PX",
                yUnit: "%",
                zUnit: "PX",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1da587d9-0b11-925c-33ad-60a9792b3d13",
                        "61b289fc-fecb-3498-1250-b91f7d377508",
                        "e2fc0ccb-df90-9bbb-e204-43120a68fc0b",
                      ],
                    },
                    xValue: 0,
                    xUnit: "%",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "1da587d9-0b11-925c-33ad-60a9792b3d13",
                        "ea1967ad-8622-8460-a05a-b0be6a0d2ca8",
                      ],
                    },
                    xValue: 0,
                    xUnit: "%",
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        ...
                        "7a800d33-f80a-3aef-ee03-ccdcd98b3091",
                      ],
                    },
                    yValue: 16,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "6a210fa6-70e2-deff-2493-295d3ef46164",
                        "f317a877-e294-75b8-ec6f-f2a2d5fc3672",
                      ],
                    },
                    yValue: 12,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "6a210fa6-70e2-deff-2493-295d3ef46164",
                        "0120faee-8302-1cbe-4505-3cceed9ba8e7",
                      ],
                    },
                    yValue: 8,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "6a210fa6-70e2-deff-2493-295d3ef46164",
                        "412ac48a-8d13-238b-3021-218019a539d9",
                      ],
                    },
                    yValue: 4,
                    xUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "89797d13-1ee6-dc47-78ce-b07fabfb8f35",
                    "f81a5540-1c79-5f80-02bc-7b9c1d0dd586",
                  ],
                },
                value: 0,
                unit: "",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "89797d13-1ee6-dc47-78ce-b07fabfb8f35",
                    "6f237876-5a64-f43e-de12-feb1d56f4b4e",
                  ],
                },
                value: 1,
                unit: "",
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                easing: "outQuart",
                duration: 200,
                target: { id: "5623632d-f38a-2d34-8114-6064e5ea4a18" },
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "ad9d207c-7112-d300-f77a-c02c32993b89" },
                xValue: -100,
                xUnit: "%",
                yUnit: "PX",
                zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "0d9eb416-5699-0575-8f30-b34bc83b201d" },
                xValue: -100,
                xUnit: "%",
                yUnit: "PX",
                zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "56e9b4c1-59f7-7df2-9ec2-359c0844168c" },
                xValue: -100,
                xUnit: "%",
                yUnit: "PX",
                zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "bd3125ab-c5db-fe45-1e48-bc5bc69386fe" },
                xValue: -48,
                xUnit: "px",
                yUnit: "PX",
                zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "70dc0722-0f27-54ea-0ea3-2c8d5f25c249" },
                xValue: -48,
                xUnit: "px",
                yUnit: "PX",
                zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "f4e01045-1c19-f8df-e2ca-8b4b9aa52193" },
                xValue: -48,
                xUnit: "px",
                yUnit: "PX",
                zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "1d6fa60f-f97c-465c-15bf-13fbd59aa990" },
                xValue: 0,
                yValue: 0,
                locked: true,
              },
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "5187d8cc-7916-280f-d1b9-6f70fc2e8982" },
                xValue: 0,
                yValue: 0,
                locked: true,
              },
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "6e5e2d49-82f6-5a57-6d38-3e8a98ec032d" },
                xValue: 0,
                yValue: 0,
                locked: true,
              },
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "81234079-ad2a-f5ed-dca0-ab59bec89053" },
                xValue: -100,
                xUnit: "%",
                yUnit: "PX",
                zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 0,
                target: { id: "adf3bcec-a7b9-7ee6-968c-bdba5e2c8a0c" },
                value: "flex",
              },
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 1000,
                target: { id: "b7fd9354-c75a-bd8c-da38-4cec0ab90d4e" },
                value: 0,
                unit: "",
              },
            },
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 1000,
                target: { id: "90bf6ac8-1aec-f014-557d-13c55d5c3ef1" },
                value: 0,
                unit: "",
              },
            },
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 1000,
                target: { id: "bbbd2257-df75-a016-a7b4-4b11c11f7555" },
                value: 0,
                unit: "",
              },
            },
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "9a4d4eb6-0d2b-855a-5231-66e32af2bc37" },
                xValue: -48,
                xUnit: "px",
                yUnit: "PX",
                zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "outQuart",
                duration: 1000,
                target: { id: "9a4d4eb6-0d2b-855a-5231-66e32af2bc39" },
                value: 0,
                unit: "",
              },
            },
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                easing: "inQuint",
                duration: 600,
                target: { id: "9a4d4eb6-0d2b-855a-5231-66e32af2bc3b" },
                xValue: -100,
                xUnit: "%",
                yUnit: "PX",
                zUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "1953c30b-d8ac-beef-a7f1-df6e01b68e43" },
                xValue: -100,
                xUnit: "%",
                yUnit: "PX",
                zUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { id: "29ee1b45-56ce-d078-234d-c9b91de1f0ab" },
                globalSwatchId: "db501570",
                rValue: 27,
                bValue: 27,
                gValue: 27,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".q.is-3",
                  selectorGuids: [
                    "80127651-7f76-2114-2389-4cbff4f5629b",
                    "2f6200d7-276d-cb50-92d8-f05f5f53ae88",
                  ],
                },
                yValue: -30,
                xUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "80127651-7f76-2114-2389-4cbff4f5629b",
                    "2a59c563-6ce0-1ad0-beb7-aa884f676847",
                  ],
                },
                value: 0,
                unit: "",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "80127651-7f76-2114-2389-4cbff4f5629b",
                    "80127651-7f76-2114-2389-4cbff4f562ab",
                  ],
                },
                yValue: -30,
                xUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "80127651-7f76-2114-2389-4cbff4f5629b",
                    "26929a89-4a4d-e9fd-8c62-699b70247876",
                  ],
                },
                value: 0,
                unit: "",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "80127651-7f76-2114-2389-4cbff4f5629b",
                    "80127651-7f76-2114-2389-4cbff4f562ac",
                  ],
                },
                yValue: -30,
                xUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "80127651-7f76-2114-2389-4cbff4f5629b",
                    "80127651-7f76-2114-2389-4cbff4f562ae",
                  ],
                },
                yValue: 30,
                xUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "80127651-7f76-2114-2389-4cbff4f5629b",
                    "2ee275bc-03f7-31d8-14a5-45532221ef8e",
                  ],
                },
                yValue: -30,
                xUnit: "PX",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "4fd1f2c1-7db8-9849-6251-0a836cb74cce",
                        "bd96d00a-1336-b769-0a82-40c321ef6a29",
                      ],
                    },
                    value: 0,
                    unit: "",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "e3eda33d-0d3c-bd85-d4c1-629d06929dad",
                    "e3eda33d-0d3c-bd85-d4c1-629d06929db1",
                  ],
                },
                value: "block",
              },
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "e3eda33d-0d3c-bd85-d4c1-629d06929dad",
                    "e3eda33d-0d3c-bd85-d4c1-629d06929daf",
                  ],
                },
                value: "block",
              },
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "e3eda33d-0d3c-bd85-d4c1-629d06929dad",
                    "e3eda33d-0d3c-bd85-d4c1-629d06929db2",
                  ],
                },
                value: "block",
              },
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "a3505c9b-fc70-daf8-2c4a-9d72fc7b5f20",
                    "f623f3b2-2db3-6610-dfe0-f69f87f47c2c",
                  ],
                },
                yValue: 50,
                xUnit: "PX",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "6fe7ba95-04bb-3b48-3f4b-b5e1257abd81",
                        "260366f5-cb30-a6ec-b586-6ca7b41aa50d",
                        "ab716df8-cd64-5121-c0ea-3b8d25935b17",
                      ],
                    },
                    xValue: -2,
                    yValue: null,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "6fe7ba95-04bb-3b48-3f4b-b5e1257abd81",
                        "c61c5b98-d5aa-d92d-5095-5e146952b21e",
                        "f446e1a3-275d-39ee-afbe-f2da835162c0",
                      ],
                    },
                    xValue: 20,
                    yValue: null,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "6fe7ba95-04bb-3b48-3f4b-b5e1257abd81",
                        "31ccd36d-78b7-1caf-1414-767229b14d3c",
                        "0f905a18-d124-3be8-0222-49842d417501",
                      ],
                    },
                    xValue: -24,
                    yValue: null,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "6fe7ba95-04bb-3b48-3f4b-b5e1257abd81",
                        "29ad4c04-9f94-28f5-378b-0acc26870e60",
                        "b513c93c-a367-fe8c-82a0-bcd40df8dc48",
                      ],
                    },
                    xValue: 8,
                    yValue: null,
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "e6de3a0f-16e2-1f1a-38cd-64175593f95b",
                        "4100013b-79d0-64e3-fc86-1aabb96d7115",
                      ],
                    },
                    yValue: 20,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "e6de3a0f-16e2-1f1a-38cd-64175593f95b",
                        "d5d10d5d-2350-98b4-8a31-7c15bc9c4dba",
                      ],
                    },
                    yValue: -2,
                    xUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "9013c5ab-3276-8148-7baf-5394a3b0a480",
                    "e7950dd7-9075-40c2-8f21-25f8396c0352",
                  ],
                },
                value: "block",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "9013c5ab-3276-8148-7baf-5394a3b0a480",
                    "8c438748-a14c-e28c-c09e-3140c08938d0",
                  ],
                },
                value: "block",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "9013c5ab-3276-8148-7baf-5394a3b0a480",
                    "22b6a8b6-feab-c829-3820-2a9303fcb797",
                  ],
                },
                value: "block",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "9013c5ab-3276-8148-7baf-5394a3b0a480",
                    "8002d5ce-243e-2595-f684-0c43897c30f2",
                  ],
                },
                value: "block",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "9013c5ab-3276-8148-7baf-5394a3b0a480",
                    "6832fb0f-4985-9fac-75df-58548c204890",
                  ],
                },
                value: "block",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "9013c5ab-3276-8148-7baf-5394a3b0a480",
                    "452cec96-489f-e385-8047-9e7116499c21",
                  ],
                },
                value: "block",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "9013c5ab-3276-8148-7baf-5394a3b0a480",
                    "ba1601c3-930a-a98c-fdce-61c0ca65a690",
                  ],
                },
                value: "block",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "9013c5ab-3276-8148-7baf-5394a3b0a480",
                    "85fba81f-3be6-ce32-82b0-93dc4296c41f",
                  ],
                },
                value: "block",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "9013c5ab-3276-8148-7baf-5394a3b0a480",
                    "ee501307-936b-7063-c45f-7653e1c7c250",
                  ],
                },
                value: "block",
              },
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "e4f0c885-4c92-a0a8-15cc-aeee67b866fb",
                    "e4f0c885-4c92-a0a8-15cc-aeee67b866ff",
                  ],
                },
                value: 0.5,
                unit: "",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "e4f0c885-4c92-a0a8-15cc-aeee67b866fc",
                    "e4f0c885-4c92-a0a8-15cc-aeee67b86700",
                  ],
                },
                xValue: -100,
                xUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "e4f0c885-4c92-a0a8-15cc-aeee67b866fc",
                    "e4f0c885-4c92-a0a8-15cc-aeee67b866fe",
                  ],
                },
                xValue: 0,
                xUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "e4f0c885-4c92-a0a8-15cc-aeee67b866fb",
                    "e4f0c885-4c92-a0a8-15cc-aeee67b86702",
                  ],
                },
                value: 1,
                unit: "",
